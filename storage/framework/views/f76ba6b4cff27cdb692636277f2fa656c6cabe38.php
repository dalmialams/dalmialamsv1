...
<script>
    ...
    $(function () {
        ...
        $('body').delegate('#survey_id', 'change', function () {
            ...
            var trxn_type = $('.trxn_type option:selected').val();
            var go_html = (trxn_type == 'Y') ? '<td class="text-center">  <?php echo e(Form::text("go[]",  "", array("class"=>"form-control go"))); ?>  </td>' : '<td class="text-center"> <?php echo e(Form::text("go[]",  "", array("class"=>"form-control","disabled" => true))); ?> </td>'
            // alert()
            var append_html = ' <tr class="parent_tr">' +
                    '<td class="">' + txt + '</td>' +
                    go_html +
                    '<td class="text-center">  <?php echo e(Form::text("remarks[]",  "", array("class"=>"form-control"))); ?>  </td>' +
