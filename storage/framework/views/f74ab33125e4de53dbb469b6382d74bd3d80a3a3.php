...
<div class="col-lg-12">
        ...
        <div class="panel panel-primary  toggle panelMove">
			...
			<form method="post" action="<?php echo e(URL('document-management/document/shape-file-update')); ?>" accept-charset="UTF-8" class="form-horizontal reg-form" enctype="multipart/form-data" role="form" autocomplete="off">
