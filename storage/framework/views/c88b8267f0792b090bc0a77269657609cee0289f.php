    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-right header_no_padding">
                ...
                <h1><span class="text-danger"><?php echo @isset($current_user_name)?$current_user_name:''; ?> <?php echo isset($current_user_role_name) ?  ' ('.$current_user_role_name.')' : ''; ?></span></h1>
            </div>
             <?php endif; ?>
            <!-- col-md-6 end here -->
            <?php if(str_contains(Request::fullUrl(), 'dashboard')): ?>
            ...
            <div class="page-content-inner">
                ...
                <!--                <div id="page-header" class="clearfix">
                                    <div class="page-header">
                                        <h2><?php echo @isset($pageHeading)?$pageHeading:''; ?></h2>
                                    </div>
                                </div>-->
                <!-- Start .row -->
                <div class="row">
