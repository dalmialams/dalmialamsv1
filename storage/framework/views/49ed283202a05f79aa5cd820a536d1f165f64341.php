...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php echo Form::open(['url' => url('transaction/disputes/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form','autocomplete'=>'off']); ?>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('disputes[state_id]', isset($states) ?$states : '' , isset($disputes_data['state_id']) ? $disputes_data['state_id'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                        ...
                        <div class="col-lg-7 col-md-9">                       
                            <?php echo e(Form::select('disputes[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , isset($disputes_data['district_id']) ? $disputes_data['district_id'] : '',array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            <?php echo e(Form::select('disputes[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , isset($disputes_data['block_id']) ? $disputes_data['block_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('disputes[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($disputes_data['village_id']) ? $disputes_data['village_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateSurvey("",$(this).val())'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group survey-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('disputes[survey_id]', isset($survey_info) ? $survey_info : array('' => 'Select') , isset($disputes_data['village_id']) ? $disputes_data['village_id'] : '',array('class'=>'form-control select2-minimum '))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="input-group">
                                ...
                                <?php echo e(Form::text('disputes[disp_date]', isset($disputes_data['disp_date']) ? $disputes_data['disp_date'] : '', array('class'=>'form-control required basic-datepicker','placeholder' => 'Date'))); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <?php echo e(Form::text('disputes[reminder_date]', isset($disputes_data['reminder_date']) ? $disputes_data['reminder_date'] : '', array('class'=>'form-control required basic-datepicker','placeholder' => 'Reminder Date'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <?php echo e(Form::text('disputes[next_hear_date]', isset($disputes_data['next_hear_date']) ? $disputes_data['next_hear_date'] : '', array('class'=>'form-control required basic-datepicker','placeholder' => 'Next Hearing Date'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('disputes[litigation_type]', isset($litigation_type) ? $litigation_type : array('' => 'Select') , isset($disputes_data['litigation_type']) ? $disputes_data['litigation_type'] : '',array('class'=>'form-control select2-minimum '))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::textarea('disputes[description]', isset($disputes_data['description']) ? $disputes_data['description'] : '', array('class'=>'form-control','placeholder' => 'Remarks','size' => '30x3'))); ?>
