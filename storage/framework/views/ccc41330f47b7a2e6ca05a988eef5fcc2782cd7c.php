    ...
    $(function () {
        ...
        $('body').delegate('#survey_id', 'change', function () {
            ...
            var append_html = ' <tr class="parent_tr">' +
                    '<td class="">' + txt + '</td>' +
                    '<td class="text-center">  <?php echo e(Form::text("transferee[]", isset($payment_data["description"]) ? $payment_data["description"] : "", array("class"=>"form-control transferee"))); ?>  </td>' +
                    '<td class="text-center">  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span>\n\
                      <?php echo e(Form::text("date_of_exchange[]", isset($reg_data["regn_date"]) ? $reg_data["regn_date"] :"", array("class"=>"form-control required basic-datepicker exchnge_date","placeholder" => "Date"))); ?></div>  </td>' +
