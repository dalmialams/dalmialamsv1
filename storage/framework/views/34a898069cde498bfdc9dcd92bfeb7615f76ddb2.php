    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary  toggle panelMove">
            ...
            <div class="panel-body">
                <?php echo Form::open(['url' => url('mis/transaction'),'class' => 'form-horizontal reg-form','method' => 'GET', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[trxn]', isset($transaction_arr) ?$transaction_arr : '' ,  '',array('class'=>'form-control select2-minimum trxn','id'=>'transaction_type'))); ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">                      
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($village_id) ? $village_id : '',array('class'=>'form-control select2-minimum village','onchange' => '','id' => 'village_id'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="survey-list">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[survey_id]', isset($all_surveys) ?$all_surveys : '' ,  '',array('class'=>'form-control select2-minimum'))); ?>
