 <?php echo $__env->make('admin.common.common_auditlog_modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="col-lg-12">
                <div class="row ">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="row" style="margin-left:0px;">
                                <div class="col-sm-6 form-group">
                                    <?php echo e(Form::select('registration[tot_area_unit]', isset($area_units) ? $area_units : '', isset($reg_data['tot_area_unit']) ? $reg_data['tot_area_unit'] : '',array('class'=>'form-control select2-minimum required'))); ?>

                                </div>
                                <div class="col-sm-6 form-group" style="margin-left:30px;">
                                    <?php echo e(Form::text('registration[tot_area]', isset($reg_data['tot_area']) ? number_format($reg_data['tot_area'], 4) : '', array('class'=>'form-control required ','placeholder' => '','style'=>'text-align:right'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('registration[tot_cost]', isset($reg_data['tot_cost']) ? $reg_data['tot_cost'] : '', array('class'=>'form-control required numbers_only_restrict','placeholder' => 'Total Cost','style'=>'text-align:right'))); ?>
