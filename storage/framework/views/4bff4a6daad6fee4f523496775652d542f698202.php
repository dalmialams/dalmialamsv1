...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php echo Form::open(['url' => url('transaction/mutation/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group patta-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('mutation[patta_id]', isset($patta_info) ? $patta_info : array('' => 'Select') , isset($mutation_data['patta_id']) ? $mutation_data['patta_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateFields($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('pattaowner', isset($patta_owner) ? $patta_owner : '', array('class'=>'form-control required','placeholder' => 'patta owner','readonly' => ''))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('mutation[new_patta_no]',isset($mutation_data['new_patta_no']) ? $mutation_data['new_patta_no'] : '', array('class'=>'form-control required','placeholder' => 'patta owner'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('mutation[new_patta_owner]',isset($mutation_data['new_patta_owner']) ? $mutation_data['new_patta_owner'] : '', array('class'=>'form-control required','placeholder' => 'patta owner'))); ?>
