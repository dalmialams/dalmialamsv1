...
<input type="hidden" name="shp_type" value="plant_boundary">
<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
 ...
 <div class="col-lg-12">
  ...
  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-center">
                        ...
                        <a href="<?= url('document-management/document/plant-boundary') ?>"><button type="button" class="btn btn-warning">Reset</button></a>
                    </div>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
			...
			<div class="panel-heading">
				...
				<h4 class="panel-title mg-right"><a class="btn btn-success" href="<?= url('document-management/document/manage-shape-data/plant_boundary') ?>">Manage Plant Boundary</a></h4>
			</div>
