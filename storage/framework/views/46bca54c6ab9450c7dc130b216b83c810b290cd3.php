...
<input type="hidden" name="shp_type" value="approach_road">
<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
 ...
 <div class="col-lg-12">
  ...
  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-center">
                        ...
                        <a href="<?= url('document-management/document/approach-road') ?>"><button type="button" class="btn btn-warning">Reset</button></a>
                    </div>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
			...
			<div class="panel-heading">
				...
				<h4 class="panel-title mg-right"><a class="btn btn-success" href="<?= url('document-management/document/manage-shape-data/approach_road') ?>">Manage Approach Road</a></h4>
			</div>
						...
						<tr>
							...
							<td>
								<div class="action-buttons">
										...
										<a title="View" href="<?= url('document-management/document/shape-file-view/' . $shp_history->id .'/' . $shp_history->shp_type); ?>">
											<i class="ace-icon fa fa-eye bigger-130"></i>
										</a>
									&nbsp;&nbsp;
									
										<a title="Delete" href="javascript:void(0);" onclick="delete_param('<?= $shp_history->id ?>');">
