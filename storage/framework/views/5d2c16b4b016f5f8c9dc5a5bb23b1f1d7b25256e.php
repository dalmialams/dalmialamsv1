...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <?php echo Form::open(['url' => url('user-management/user/loginlog'),'class' => 'form-horizontal user-form','method' => 'GET', 'enctype' => 'multipart/form-data','role' => 'form','autocomplete'=>'off']); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                        ...
                        <a href="<?= url('user-management/user/loginlog') ?>"><button type="button" class="btn btn-warning">Reset</button></a>
                    </div>
                </div>
                <!-- End .row -->
            </div>
