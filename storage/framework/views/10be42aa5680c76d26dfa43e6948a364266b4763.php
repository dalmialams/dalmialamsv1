                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::text('survey[purchased_area]', isset($survey_data['purchased_area']) ? round($survey_data['purchased_area'],2) : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Purchased Area','id'=>'purchased_area','style'=>'text-align:right;'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="classificationList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('survey[classification]', isset($plot_classification) ?$plot_classification : '' , isset($survey_data['classification']) ? $survey_data['classification'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populatesubclassification($(this).val())'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group subclassificationList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('survey[sub_classification]', isset($sub_classinfo) ? $sub_classinfo : array('' => 'Select') , isset($survey_data['sub_classification']) ? $survey_data['sub_classification'] : '',array('class'=>'form-control select2-minimum'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <label class="col-lg-5 col-md-3 control-label" style="color: #db5565" id='total_area_in_level'><?= round($reg_data['tot_area'],4); ?></label>
                        </div>
