...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php echo Form::open(['url' => url('transaction/land-exchange/submit-data'),'class' => 'form-horizontal land-exchange-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
            ...
            <div class="col-lg-12">
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('land_exchange[state_id]', isset($states) ?$states : '' , $state_id ,array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">                       
                                <?php echo e(Form::select('land_exchange[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , $district_id ,array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">  
                                <?php echo e(Form::select('land_exchange[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , $block_id ,array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('land_exchange[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , $village_id,array('class'=>'form-control select2-minimum ','onchange' => 'populateSurvey("",$(this).val())','id' => 'village_id'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group survey_id">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('land_exchange[survey_id]', isset($survey_info) ? $survey_info : array('' => 'Select') , isset($land_exchange_data['village_id']) ? $land_exchange_data['village_id'] : '',array('class'=>'form-control select2-minimum','id' => 'survey_id'))); ?>
                        ...
                        <tbody class="append">
                            <?php foreach ($reserved_surveys as $key => $value) { ?>
                                <tr class="parent_tr">
                                    ...
                                    <td class="text-center">  <?php echo e(Form::text("transferee[]", isset($value["transferee"]) ? $value["transferee"] : "", array("class"=>"form-control transferee"))); ?>  </td>
                                    <td class="text-center"> 
                                        ...
                                        <div class="input-group"> 
                                            ...
                                            <?php echo e(Form::text("date_of_exchange[]", isset($date_of_exchange) ? $date_of_exchange :"", array("class"=>"form-control required basic-datepicker exchnge_date","placeholder" => "Date"))); ?>
