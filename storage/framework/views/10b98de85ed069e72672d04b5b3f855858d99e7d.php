...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php echo Form::open(['url' => url('transaction/inspection/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('inspection[state_id]', isset($states) ?$states : '' , isset($inspection_data['state_id']) ? $inspection_data['state_id'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                        ...
                        <div class="col-lg-7 col-md-9">                       
                            <?php echo e(Form::select('inspection[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , isset($inspection_data['district_id']) ? $inspection_data['district_id'] : '',array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            <?php echo e(Form::select('inspection[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , isset($inspection_data['block_id']) ? $inspection_data['block_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('inspection[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($inspection_data['village_id']) ? $inspection_data['village_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateSurvey("",$(this).val())'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group survey-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('inspection[survey_id]', isset($survey_info) ? $survey_info : array('' => 'Select') , isset($inspection_data['village_id']) ? $inspection_data['village_id'] : '',array('class'=>'form-control select2-minimum '))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="input-group paymentValidate">
                                ...
                                <?php echo e(Form::text('inspection[insp_date]', isset($inspection_data['insp_date']) ? $inspection_data['insp_date'] : '', array('class'=>'form-control required','placeholder' => 'Date','id'=>'basic-datepicker'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('inspection[encroachment]', isset($encroachment_info) ? $encroachment_info : array('' => 'Select') , isset($inspection_data['encroachment']) ? $inspection_data['encroachment'] : '',array('class'=>'form-control select2-minimum ','onchange'=>'validateform($(this).find("option:selected").text())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('inspection[encroachment_type]', isset($encroachment_type) ? $encroachment_type : array('' => 'Select') , isset($inspection_data['encroachment_type']) ? $inspection_data['encroachment_type'] : '',array('class'=>'form-control select2-minimum ','onchange'=>'validateform1($(this).find("option:selected").text())'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::textarea('inspection[description]', isset($inspection_data['description']) ? $inspection_data['description'] : '', array('class'=>'form-control','placeholder' => 'Remarks','size' => '30x3'))); ?>
