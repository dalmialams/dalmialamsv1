...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php echo Form::open(['url' => url('transaction/under-operation/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('operation[state_id]', isset($states) ?$states : '' , isset($operation_data['state_id']) ? $operation_data['state_id'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                        ...
                        <div class="col-lg-7 col-md-9">                       
                            <?php echo e(Form::select('operation[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , isset($operation_data['district_id']) ? $operation_data['district_id'] : '',array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            <?php echo e(Form::select('operation[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , isset($operation_data['block_id']) ? $operation_data['block_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('operation[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($operation_data['village_id']) ? $operation_data['village_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateSurvey("",$(this).val())'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group survey-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('operation[survey_id]', isset($survey_info) ? $survey_info : array('' => 'Select') , isset($operation_data['survey_id']) ? $operation_data['survey_id'] : '',array('class'=>'form-control select2-minimum '))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('operation[operation_type]', isset($operation_type) ? $operation_type : array('' => 'Select') , isset($operation_data['operation_type']) ? $operation_data['operation_type'] : '',array('class'=>'form-control select2-minimum '))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::textarea('operation[description]', isset($operation_data['description']) ? $operation_data['description'] : '', array('class'=>'form-control','placeholder' => 'Remarks','size' => '30x3'))); ?>
