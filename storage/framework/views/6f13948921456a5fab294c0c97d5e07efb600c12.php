...
<?php $__env->startSection('content'); ?>
    <!-- begin::Head -->
    <head>
		<?php echo e(HTML::style('assets/css/ol.css')); ?>

		<?php echo e(HTML::style('assets/css/vector.css')); ?>
...
.ui-widget input, .ui-widget select, .ui-widget textarea, .ui-widget button {
    ...
    font-size: 0.9em !important;
		...
		<?php echo e(HTML::style('assets/css/style.bundle.css')); ?>
...
<div id="multi_selection_dialog" title="Multi Selection" style="display:none">
	...
	<div class="row">
		...
		<?php echo e(HTML::script('assets/js/ol.js')); ?>

		
		<!--<?php echo e(HTML::script('assets/plugins/forms/select2/select2.js')); ?>-->
...
var vectorSource;
 ...
 $('#range_val').bind('keyup paste', function(){
		...
		<?php echo e(HTML::script('assets/js/measure.js')); ?>
