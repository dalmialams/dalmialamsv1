...
class BlockController extends Controller {
    ...
    public function blockList($option = true) {
        ...
        $sql = 'SELECT 
                    "T_BLOCK".*,
                    "T_STATE".state_name,
                    "T_DISTRICT".district_name
                FROM 
                    "T_BLOCK" 
                JOIN "T_STATE" ON "T_BLOCK"."state_id" = "T_STATE"."id" AND "T_STATE"."fl_archive" = \'N\'
                JOIN "T_DISTRICT" ON "T_BLOCK"."district_id" = "T_DISTRICT"."id" AND "T_DISTRICT"."fl_archive" = \'N\'
                WHERE "T_BLOCK".fl_archive = \'N\'
                ORDER BY "T_BLOCK".block_name';
        $block = DB::select($sql);
        // dd($block);
    ...
    public function processData(Request $request) {
        ...
        $id = isset($posted_data['id']) && !empty($posted_data['id']) ? $posted_data['id'] : '';
        ...
        if ($id != "") {
            ...
            $data_to_update['update_role_id'] = isset($this->role_id) ? $this->role_id : 'admin';
            ...
            $data_to_insert['insert_role_id'] = isset($this->role_id) ? $this->role_id : 'admin';
