...
class PaymentDetails extends Controller {
    ...
    public function add(Request $request) {
        ...
        if (isset($this->assgined_districts_str) && !empty($this->assgined_districts_str)) {
            ...
            $reg_id_arr = RegistrationModel::whereRaw("district_id in ($this->assgined_districts_str)")->orderBy('id')->pluck('id', 'id')->toArray();
        } else {
            $reg_id_arr = RegistrationModel::orderBy('id')->pluck('id', 'id')->toArray();
        }
