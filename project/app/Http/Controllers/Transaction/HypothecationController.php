...
class HypothecationController extends Controller {
    ...
    protected $field_names = [
        'hypothecate.hyp_name' => 'Mortgage Land Name',
        'hypothecate.trxn_type' => 'Transaction Type',
        'hypothecate.reg_no' => 'Registration No.',
        'hypothecate.hyp_with' => 'Mortgage Land With',
    ...
    public function edit(Request $request, $id = null) {
        ...
        if ($id) {
            ...
            if ($hypothecate_data) {
                $related_registration_ids = HypotheticationRegistrationModel::where(['hypothecate_id' => $hypothecate_data[0]['id'], 'fl_archive' => 'N'])->pluck('registration_id', 'registration_id')->toArray();
