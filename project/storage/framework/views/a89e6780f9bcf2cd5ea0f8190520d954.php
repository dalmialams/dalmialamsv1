...
<!-- <form method="get" id="add_development_plan"  class="form-horizontal dash-form" enctype="multipart/form-data" >
                    <?php echo csrf_field(); ?> -->
    ...
    <div class="row row-header">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group select_criteria" >
		 ...
		 <div class="col-lg-8 col-md-8">
            <!-- <select class="form-control select2-minimum" onchange = "this.form.submit()" name = "filter">
                <option value="" >Select</option>
                <option value = "State" <?php if(isset($filter) && ($filter == "State")){ echo"selected"; } ?>>State</option>
                <option value = "District" <?php if(isset($filter) && ($filter == "District")){ echo"selected"; } ?> >District</option>
                <option value = "Block/Taluk" <?php if(isset($filter) && ($filter == "Block/Taluk")){ echo"selected"; } ?>  > Block/Taluk </option>
                <option value = "Village" <?php if(isset($filter) && ($filter == "Village")){ echo"selected"; } ?> > Village </option>
            </select> -->
...
<!-- </form> --><?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/dashboard/selectionCriteria.blade.php ENDPATH**/ ?>