...
<?php $__env->startSection('content'); ?>
    ...
    <head>
		...
		<link href="<?php echo e(url('assets/css/ol.css')); ?>" rel="stylesheet" type="text/css"/>
        <link href="<?php echo e(url('assets/css/vector.css')); ?>" rel="stylesheet" type="text/css"/>
...
.ui-widget input, .ui-widget select, .ui-widget textarea, .ui-widget button {
    ...
    font-size: 0.9em !important;
        ...
        <link href="<?php echo e(url('assets/frontend/css/flaticon/flaticon.css')); ?>" rel="stylesheet" type="text/css"/>
		<link href="<?php echo e(url('assets/frontend/css/flaticon2/flaticon.css')); ?>" rel="stylesheet" type="text/css"/>
                                ...
                                <div class="button_group">
                                    <div class="btn-group pull-right">
                                       ...
                                       <button type="button" id="noprint" class="btn btn-info" onclick="printMap()" title="Print Map">
										 ...
										 <button type="button" class="btn btn-primary" title="Export to SHP"  onclick="location.href='<?php echo e(url('map/exportShp')); ?>'">
										...
										<!-- <button type="button" class="btn btn-primary" title="Export to KML"  onclick="location.href='<?php echo e(url('map/exportKml')); ?>'">-->
 ...
 <div style="text-align:center">
                        <h4 class="panel-title" style="text-align:center;"><span id="print_title" class="print_title" style="display:none;"></span></h4>
							...
							<div class="row">	
									...
									<div class="col-sm-2 custom_list_on_map">
										<table class="table" id="layer_legend" style="border-collapse:collapse;">
											<thead>
												<tr data-toggle="collapse" data-target=".app_layer"><th><b>Layer Legend </b></th>
													</tr>
											</thead>
											<tbody>	                                              
												<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="parcel_boundry_id" value="parcel_boundry"> <i class="colorpick-btn" style="border:2px solid #FFFF00;"></i>  Survey Plot</span>
													</td>
												 ...
												 <!--<tr>
												  ...
												  <tr>
													...
													<tr class="hiddenRow">
                                                     <td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="lease_boundary_layer_id" value="lease_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #FF0000;"></i> Mining Lease Boundary</span>
													</td>
													</tr>
													<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="plant_boundary_layer_id" value="plant_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #A52A2A;"></i> Plant Boundary</span>
													</td>
													</tr>
													
													<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="colony_boundary_layer_id" value="colony_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #006400;"></i>  Colony Boundary</span>
													</td>
													</tr>
													
													<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="railway_sliding_boundary_layer_id" value="railway_sliding_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #0000FF;"></i>  Railway Sliding Boundary</span>
													</td>
													</tr>
													
													<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="approach_road_layer_id" value="approach_road_layer"> <i class="colorpick-btn" style="border:2px solid #000000;"></i> Approach Road</span>
													</td>
													</tr>
													
													<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="conveyor_belt_layer_id" value="conveyor_belt_layer"> <i class="colorpick-btn" style="border:2px solid #800080;"></i>  Conveyor Belt</span>
													</td>
													</tr>
													
													<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="railway_line_boundary_layer_id" value="railway_line_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #000000;"></i>  Railway Track</span>
													</td>
													</tr>
													
													<tr class="hiddenRow">
													<td class="collapse in app_layer">
														<span><input type="checkbox" class="layer" checked="true" id="crusher_location_layer_id" value="crusher_location_layer"> <i class="colorpick-btn" style="border:2px solid #FFA500;"></i>  Crusher Location</span>
													</td>
													</tr>
										...
										<table class="table" style="border-collapse:collapse;">
											<thead>
											<tr data-toggle="collapse" data-target=".ras_layer"><th><b>Raster layers </b></th>
													</tr>
											</thead>
											<tbody>	
												<tr class="hiddenRow">
													
													<td class="collapse ras_layer">	
														<span><input type="checkbox" class="layer" checked="false" id="layer_Resource_AndhraPradesh_id" value="layer_Resource_AndhraPradesh">  Resource AndhraPradesh</span>
													</td>																										
												 </tr>
												 <tr class="hiddenRow">
													
													<td class="collapse ras_layer">	
														<span><input type="checkbox" class="layer" checked="false" id="layer58N1_id" value="layer58N1"> 58N1</span>
													</td>																										
												 </tr>
												 <tr class="hiddenRow">
													
													<td class="collapse ras_layer">	
														<span><input type="checkbox" class="layer" checked="false" id="layer58M4_id" value="layer58M4">  58M4</span>
													</td>																										
												 </tr>
												 <tr class="hiddenRow">
													
													<td class="collapse ras_layer">	
														<span><input type="checkbox" class="layer" checked="false" id="layer58J13_id" value="layer58J13"> 58J13</span>
													</td>																										
												 </tr>	
										...
										<table class="table" style="border-collapse:collapse;">
										<thead>
											<tr data-toggle="collapse" data-target=".base_map"><th><b>Base Map </b></th>
													</tr>
											</thead>
											<tbody>
											<tr class="hiddenRow"><td class="collapse base_map">											
...
<div id="upload_kml_file1" title="Upload KML File" style="display:none;">
                <?php echo Form::open(['class' => 'form-horizontal kml_upload_form','method' => 'POST', 'id' => 'kml_upload_form','autocomplete'=>'off', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
...
<div id="multi_selection_dialog" title="Multi Selection" style="display:none">
	...
	<div class="row">
		...
		<script src="<?php echo e(url('assets/js/ol.js')); ?>" type="text/javascript"></script>
		
		<script src="<?php echo e(url('assets/js/measure.js')); ?>"></script>
	...
	if (lyr === layers.item(i).get('name')) {
		...
		//layer layer58J13
			...
			source: new ol.source.TileWMS({
				...
				params: {
					...
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 75.12799072265625 + "," + 10.650009155273438
				}
			})
		});
		...
		// Approach Road
		var approach_road_layer = new ol.layer.Tile({
			visible: true,
			name: 'approach_road_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_APPROACH_ROAD',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 79.1550598144531 + "," + 11.0369215011597
				}
			})
		...
		// Colony Boundary
		var colony_boundary_layer = new ol.layer.Tile({
			visible: true,
			name: 'colony_boundary_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_COLONY_BOUNDARY',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 79.1550598144531 + "," + 11.0369215011597
				}
			})
		...
		// Conveyor Belt
		var conveyor_belt_layer = new ol.layer.Tile({
			visible: true,
			name: 'conveyor_belt_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_CONVEYOR_BELT',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 79.1550598144531 + "," + 11.0369215011597
				}
			})
		...
		// crusher location
		var crusher_location_layer = new ol.layer.Tile({
			visible: true,
			name: 'crusher_location_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_CRUSHER_LOCATION',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 79.1550598144531 + "," + 11.0369215011597
				}
			})
		...
		// lease boundary
		var lease_boundary_layer = new ol.layer.Tile({
			visible: true,
			name: 'lease_boundary_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_LEASE_BOUNDARY',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 77.20394393489559 + "," + 17.184220655106387
				}
			})
		});
		
		// plant boundary
		var plant_boundary_layer = new ol.layer.Tile({
			visible: true,
			name: 'plant_boundary_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_PLANT_BOUNDARY',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 79.1550598144531 + "," + 11.0369215011597
				}
			})
		...
		var railway_line_boundary_layer = new ol.layer.Tile({
			visible: true,
			name: 'railway_line_boundary_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_RAILWAY_LINE',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 79.1550598144531 + "," + 11.0369215011597
				}
			})
		...
		var railway_sliding_boundary_layer = new ol.layer.Tile({
			visible: true,
			name: 'railway_sliding_boundary_layer',
			crossOrigin: 'anonymous',
			source: new ol.source.TileWMS({
				url: '<?php echo $geo_url;?>',
				params: {
					...
					'VERSION': '1.1.1',
					tiled: true,
					"LAYERS": 'DALMIA-LAMS:T_RAILWAY_SLIDING',
					"exceptions": 'application/vnd.ogc.se_inimage',
					tilesOrigin: 79.1550598144531 + "," + 11.0369215011597
				}
			})
...
///
		...
		var map = new ol.Map({
			...
			layers: [
				bingLayer, layer_Resource_AndhraPradesh,layer58N1,layer58M4,layer58J13,parcel_boundry,district_layer,state_layer,plant_boundary_layer,colony_boundary_layer,approach_road_layer,conveyor_belt_layer,crusher_location_layer,lease_boundary_layer,railway_line_boundary_layer,railway_sliding_boundary_layer,plotselect,plotselect_draw
			],
			target: 'map',
			view: new ol.View({
				maxZoom: 19,
 ...
 $('#range_val').bind('keyup paste', function(){
		...
		//else { $('#code_value').html('<option value="">Select</option>');}	
			...
			$(document).on('click', ".zoom-to-layer", function(index) {
				...
				}else if(layer_value == 'colony_boundary_layer'){
					zoomToPlayer('colony_boundary_layer');					
				}else if(layer_value == 'conveyor_belt_layer'){
					zoomToPlayer('conveyor_belt_layer');					
				}else if(layer_value == 'crusher_location_layer'){
					zoomToPlayer('crusher_location_layer');					
				}else if(layer_value == 'lease_boundary_layer'){
					zoomToPlayer('lease_boundary_layer');					
				}else if(layer_value == 'plant_boundary_layer'){
					zoomToPlayer('plant_boundary_layer');					
				}else if(layer_value == 'railway_line_boundary_layer'){
					zoomToPlayer('railway_line_boundary_layer');					
				}else if(layer_value == 'railway_sliding_boundary_layer'){
					zoomToPlayer('railway_sliding_boundary_layer');					
				}else if(layer_value == 'approach_road_layer'){
					zoomToPlayer('approach_road_layer');					
				}else{			   
		...
		$(document).ready(function () {
		$( "#layer_Resource_AndhraPradesh_id" ).prop( "checked", false );	
		$( "#layer58N1_id" ).prop( "checked", false );	
		$( "#layer58M4_id" ).prop( "checked", false );	
		$( "#layer58J13_id" ).prop( "checked", false );	
...
<?php echo $__env->make('admin.layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dalmia_lams\resources\views/admin/map/index.blade.php ENDPATH**/ ?>