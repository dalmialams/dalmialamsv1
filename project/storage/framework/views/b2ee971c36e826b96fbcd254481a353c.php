...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php echo Form::open(['url' => url('land-details-entry/lease/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
...
<?php } ?>
<?php /**PATH C:\wamp64\www\dalmia_lams\resources\views/admin/LandEntryManagement/LeaseManagement/form.blade.php ENDPATH**/ ?>