        ...
        <table id="master_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th  class="text-center">Action <a href="<?php echo e(url('master/tehsil/management/add')); ?>" class="btn btn-info pull-right">Add</a></th>
                ...
                if ($blockList) {
                    foreach ($blockList as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td  class="text-center">
                                <a href="<?php echo e(URL::to('master/tehsil/management/edit/'.$value->id)); ?>"> 
...
<?php echo $__env->make('admin.layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dalmia_lams\resources\views/admin/MasterDataManagement/block.blade.php ENDPATH**/ ?>