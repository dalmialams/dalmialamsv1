...
<script>
    ...
    $(function () {
        ...
        $('#total_area').autoNumeric('init', {mDec: 3,dGroup: 2});
        $('#purchased_area').autoNumeric('init', {mDec: 3,dGroup: 2});
        $('#total_area_in_level').autoNumeric('init', {mDec: 3,dGroup: 2});
...
//            });
        ...
        $(".check_calculation").keyup(function () {
            ...
            var permission_purchase_area = '<?php echo round(( $reg_data['tot_area'] - $grand_total_purchase_area['grand_total_purchase_area'] ),3)?>';
	   ...
	   var total_area1 = $('#total_area').val();
         ...
         $('.all_total_cost').autoNumeric('init', {mDec: 3,dGroup: 2});
...
</script><?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/LandEntryManagement/SurveyOnDetails/script.blade.php ENDPATH**/ ?>