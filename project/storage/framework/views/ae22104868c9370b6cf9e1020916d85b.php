 <?php echo $__env->make('admin.common.common_auditlog_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
                ...
                <table class="table  table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td  class="text-center"><strong>SAP Asset Code</strong></td>
                            <td  class="text-center"><?= $reg_data['sap_asset_code'] ?></td>
                            
                        </tr>
                        <tr>
                            <td class="text-center" width="30%"><strong>SAP Book Value</strong></td>
                            <td class="text-center"><?= $reg_data['tot_cost'] ?></td>
                            <td class="text-center"><strong>Total Cost</strong></td>
                            <td class="text-center"><?= $totalcost ?></td>
                        </tr>
                         <tr>
                            <td class="text-center" width="30%"><strong>SAP Company Code</strong></td>
                            <td class="text-center"><?= $reg_data['sap_company_code'] ?></td>
                        </tr>
                        <tr>
    ...
    <?php } else {  ?>
        <div class="panel-body">
            <?php echo Form::open(['url' => url('land-details-entry/registration/submit-data'),'class' => 'form-horizontal reg-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('reg_id', isset($reg_data['id']) ? $reg_data['id'] : '', array('class'=>'form-control','disabled' => '','placeholder' => 'Unique ID No'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            ...
                            <?php echo e(Form::select('registration[legal_entity]', isset($legal_entry) ? $legal_entry : '', isset($reg_data['legal_entity']) ? $reg_data['legal_entity'] : '',array('class'=>'form-control select2-minimum required'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row ">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        <label class="col-lg-5 col-md-3 control-label"><span class="red" style="color:red">* </span>SAP Asset Code</label>
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('registration[sap_asset_code]', isset($reg_data['sap_asset_code']) ? $reg_data['sap_asset_code'] : '', array('class'=>'form-control paymentValidate','placeholder' => 'SAP Asset Code','id'=>'sap_asset_code'))); ?>

                        </div>
                    </div>
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        <label class="col-lg-5 col-md-3 control-label"><span class="red" style="color:red">* </span>SAP Company Code</label>
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('registration[sap_company_code]', isset($reg_data['sap_company_code']) ? $reg_data['sap_company_code'] : '', array('class'=>'form-control paymentValidate','placeholder' => 'SAP Company Code','id'=>'sap_company_code'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('registration[purchase_type_id]', isset($purchase_type) ? $purchase_type : '', isset($reg_data['purchase_type_id']) ? $reg_data['purchase_type_id'] : '',array('class'=>'form-control select2-minimum required','onchange'=>'validateform($(this).find("option:selected").text())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('registration[purchaser]', isset($purchase) ? $purchase : '', isset($reg_data['purchaser']) ? $reg_data['purchaser'] : '',array('class'=>'form-control select2-minimum required','onchange'=>'validateform($(this).find("option:selected").text())'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('registration[purchasing_team_id]', isset($purchasing_team) ? $purchasing_team : '', isset($reg_data['purchasing_team_id']) ? $reg_data['purchasing_team_id'] : '',array('class'=>'form-control select2-minimum required'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('registration[plot_type_id]', isset($plot_type) ? $plot_type : '', isset($reg_data['plot_type_id']) ? $reg_data['plot_type_id'] : '',array('class'=>'form-control select2-minimum required'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('registration[regn_no]', isset($reg_data['regn_no']) ? $reg_data['regn_no'] : '', array('class'=>'form-control paymentValidate','placeholder' => 'Document Regn No'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="input-group paymentValidate">
                                ...
                                <?php echo e(Form::text('registration[regn_date]', isset($reg_data['regn_date']) ? date('d/m/Y',strtotime($reg_data['regn_date'])) : '', array('class'=>'form-control required','placeholder' => 'Date','id'=>'basic-datepicker'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('registration[sub_registrar]', isset($sub_registrar_office) ? $sub_registrar_office : '', isset($reg_data['sub_registrar']) ? $reg_data['sub_registrar'] : '',array('class'=>'form-control select2-minimum required'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::text('registration[vendor]', isset($reg_data['vendor']) ? $reg_data['vendor'] : '', array('class'=>'form-control required','placeholder' => 'Name of Vendor'))); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('registration[state_id]', isset($states) ?$states : '' , isset($reg_data['state_id']) ? $reg_data['state_id'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                        ...
                        <div class="col-lg-7 col-md-9">                       
                            <?php echo e(Form::select('registration[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , isset($reg_data['district_id']) ? $reg_data['district_id'] : '',array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            <?php echo e(Form::select('registration[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , isset($reg_data['block_id']) ? $reg_data['block_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php echo e(Form::select('registration[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($reg_data['village_id']) ? $reg_data['village_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => ''))); ?>
...
<?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/LandEntryManagement/Registration/form.blade.php ENDPATH**/ ?>