...
<div id="header" class="header-fixed">
    ...
    <div class="container-flex">
        ...
        <a href="<?= $url ?>" class="logo">
            <img src="<?php echo e(url('assets/img/left_logo.png')); ?>" alt="Dalmia Lams">
        </a>
...
<?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/common/navbar.blade.php ENDPATH**/ ?>