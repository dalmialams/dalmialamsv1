    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary  toggle panelMove">
            ...
            <div class="panel-body">
                <?php echo Form::open(['url' => url('land-details-entry/registration/list'),'class' => 'form-horizontal reg-form','method' => 'GET', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[state_id]', isset($states) ?$states : '' , isset($state_id) ? $state_id : '',array('class'=>'form-control select2-minimum','onchange' => 'populateDistrict($(this).val())'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                <?php echo e(Form::select('registration[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , isset($district_id) ? $district_id : '',array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                <?php echo e(Form::select('registration[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , isset($block_id) ? $block_id : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($village_id) ? $village_id : '',array('class'=>'form-control select2-minimum ','onchange' => ''))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[sub_registrar]', isset($sub_registrar_office) ? $sub_registrar_office : '', isset($sub_registrar) ? $sub_registrar : '',array('class'=>'form-control select2-minimum required'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::text('registration[regn_no]', isset($regn_no) ? $regn_no : '', array('class'=>'form-control','placeholder' => 'Regn No'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::text('registration[id]', isset($id) ? $id : '', array('class'=>'form-control','placeholder' => 'Unique No'))); ?>
                        ...
                        <!--                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                ...
                                                <div class="col-lg-7 col-md-9">
                                                    <?php echo e(Form::text('registration[vendor]', isset($reg_data['vendor']) ? $reg_data['vendor'] : '', array('class'=>'form-control','placeholder' => 'Survey No'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[purchase_type_id]', isset($purchase_type) ? $purchase_type : '', isset($purchase_type_id) ? $purchase_type_id : '',array('class'=>'form-control select2-minimum '))); ?>
                    ...
                    <div class="row ">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group paymentValidate">
                                            ...
                                            <?php echo e(Form::text('registration[from_date]', isset($from_date) ? $from_date : '', array('class'=>'form-control basic-datepicker','placeholder' => 'From'))); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group paymentValidate">
                                            <!--<span class="input-group-addon"><i class="fa fa-calendar"></i></span>-->
                                            <?php echo e(Form::text('registration[to_date]', isset($to_date) ? $to_date : '', array('class'=>'form-control basic-datepicker','placeholder' => 'To'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                ...
                                <?php echo e(Form::select('registration[legal_entity]', isset($legal_entry) ? $legal_entry : '', isset($legal_entity) ? $legal_entity : '',array('class'=>'form-control select2-minimum '))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[purchaser]', isset($purchase) ?$purchase : '' , isset($purchaser) ? $purchaser : '',array('class'=>'form-control select2-minimum'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                <?php echo e(Form::select('registration[purchasing_team_id]', isset($purchasing_team) ?$purchasing_team : array('' => 'Select') , isset($purchasing_team_id) ? $purchasing_team_id : '',array('class'=>'form-control select2-minimum'))); ?>
                    ...
                    <div class="row ">
                        ...
                        if ($user_type == 'admin' || (\App\Models\UtilityModel::ifHasPermission('survey_no_details_search', $current_user_id) && \App\Models\UtilityModel::ifHasPermission('registration_access', $current_user_id))) {
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="">
                                ...
                                <label class="col-lg-5 col-md-3 control-label">Survey No</label>
                                <div class="col-lg-7 col-md-9">
                                    <?php echo e(Form::select('registration[survey_no]', isset($survey_list) ?$survey_list : array('' => 'Select') , isset($survey_no) ? $survey_no : '',array('class'=>'form-control select2'))); ?>
                        ...
                        <?php } else { ?>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="">
                                <label class="col-lg-5 col-md-3 control-label">Survey No</label>
                                <div class="col-lg-7 col-md-9">
                                    <?php echo e(Form::select('registration[survey_no]', isset($survey_list) ?$survey_list : array('' => 'Select') , isset($survey_no) ? $survey_no : '',array('class'=>'form-control select2','disabled' => 'true'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                <?php echo e(Form::select('registration[purpose]', isset($land_usage) ?$land_usage : array('' => 'Select') , isset($purpose) ? $purpose : '',array('class'=>'form-control select2-minimum'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="classificationList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('registration[classification]', isset($plot_classification) ?$plot_classification : '' , isset($classification) ? $classification : '',array('class'=>'form-control select2-minimum','onchange' => 'populatesubclassification($(this).val())'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group subclassificationList">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                <?php echo e(Form::select('registration[sub_classification]', isset($sub_classinfo) ? $sub_classinfo : array('' => 'Select') , isset($sub_classification) ? $sub_classification : '',array('class'=>'form-control select2-minimum required sub_classification'))); ?>
...
//                                        echo $unit_name1;
                                        ...
                                        <td style="text-align: right;" class="all_total_area"><?php
                                                ...
                                                if(!empty($tot_area_unit) && !empty($total_area)){
                                                ...
                                                $cumilativeTitalArea += $purchase_area_unit_value_acer;
                                                echo $purchase_area_unit_value_acer;
                                            ?>
                                        </td>
            <!--                                    <td>
                                        <?php
                        ...
                        <thead>
                            <tr>
                                ...
                                <!--<th>Unit</th>-->
                                <th class="text-right all_total_cost"><?= isset($sumResult) ? $sumResult : '' ?></th>
                                <th></th>
                            </tr>
                        </thead>
...
<?php echo $__env->make('admin.layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/LandEntryManagement/Registration/list.blade.php ENDPATH**/ ?>