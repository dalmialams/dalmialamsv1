                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <input type="file" name="doc_file[]" multiple class="filestyle" data-buttonText="Add file" data-buttonName="btn-danger" data-iconName="fa fa-plus">
                        ...
                        foreach ($paymentLists as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td  class="text-center">
                                    <?php
                                        // echo
                                        $allPaths = !empty($value['path']) ? $value['path'] : null;
                                        $allFileTypes = !empty($value['file_type']) ? $value['file_type'] : null;
                                        $file_exist = 0;
                                        if(!empty($allPaths) && !empty($allFileTypes)){
                                            for($p = 0; $p < count($allPaths); $p++){
                                                $file_path = $allPaths[$p];
                                                $file_path = str_replace('\\', '/', $file_path);
                                                $file_name = stristr($file_path, '/');
                                                $file_type = $allFileTypes[$p];
...
<?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/LandEntryManagement/PaymentDetails/form.blade.php ENDPATH**/ ?>