...
@media print {
  ...
  .logo { display:block !important; margin-top:10px !important;
  width: 100px !important; float:left !importnat; position: absolute;} 
...
#survey_table {page-break-inside: avoid;}
...
?>
<div><?php echo Session::get('message'); ?></div><button id="noprint" class="btn btn-info" onclick="printView()">Print</button>
<div id="printdiv" >
...
<!-- Registration details --->
    ...
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh" id="reg_table">
        <div class="panel-heading">
...
<!---- survey plot ----->
    ...
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh" id="survey_table">
        <div class="panel-heading">
                    ...
                    if ($surveyPlotData) {
                        ...
                        foreach ($surveyPlotData as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;" class="all_total_area">
                                    <?php
                                    $cumulativeTotalArea = 0;
                                    $cumulativeTotalArea = floatval($cumulativeTotalArea) + floatval($value['total_area']);
                                ...
                                <td style="text-align: right;" class="all_total_area"><?php
                                    ...
                                    $cumilativePurchaseArea = floatval($cumilativePurchaseArea) + floatval($value['purchased_area']);
...
<?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/LandEntryManagement/SurveyLatLong/form.blade.php ENDPATH**/ ?>