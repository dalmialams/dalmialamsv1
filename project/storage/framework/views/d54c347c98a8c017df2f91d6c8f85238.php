...
<div id="map_data_view"  style="display:block">
		...
		<script src="<?php echo e(url('assets/plugins/forms/select2/select2.js')); ?>" type="text/javascript"></script>
        <script>
...
<script src="<?php echo e(url('assets/js/measure.js')); ?>" type="text/javascript"></script>

		
    <script src="https://code.jquery.com/ui/1.11.4/jquery-ui.js"></script>

  <link rel="stylesheet" href="https://code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css"><?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/dashboard/state.blade.php ENDPATH**/ ?>