...
<?php if(!empty(Session::get('error-message'))): ?>
    <div class="alert alert-danger"><a href="javascript:void(0);" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong><?php echo Session::get('error-message'); ?></strong></div>
<?php endif; ?>
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php if ($reg_uniq_no) { ?>
                <?php echo Form::open(['url' => url('land-details-entry/survey/submit-data'),'class' => 'form-horizontal survey-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']); ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <input type="hidden" name="survey[id]" value="<?php echo e(isset($survey_data['id']) ? base64_encode($survey_data['id']) : ""); ?>">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            <label class="col-lg-5 col-md-3 control-label"><span class="red" style="color:red">* </span>Survey No</label>
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::text('survey[survey_no]', isset($survey_data['survey_no']) ? $survey_data['survey_no'] : '', array('class'=>'form-control required','placeholder' => 'Survey No'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <?php echo e(Form::select('survey[area_unit]', isset($area_units) ?$area_units : '' , isset($survey_data['area_unit']) ? $survey_data['area_unit'] : '',array('class'=>'form-control select2-minimum required'))); ?>

                                    </div>
                                    <div class="col-sm-6">
                                        <?php echo e(Form::text('survey[total_area]', isset($survey_data['total_area']) ? $survey_data['total_area'] : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Total Area','id'=>'total_area','style'=>'text-align:right;'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::text('survey[purchased_area]', isset($survey_data['purchased_area']) ? round($survey_data['purchased_area'],3) : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Purchased Area','id'=>'purchased_area','style'=>'text-align:right;'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::select('survey[purpose]', isset($land_usage) ?$land_usage : '' , isset($survey_data['purpose']) ? $survey_data['purpose'] : '',array('class'=>'form-control select2-minimum required'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::text('survey[patta_no]', isset($survey_data['patta_no']) ? round($survey_data['patta_no'],3) : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Patta Number','id'=>'purchased_area','style'=>'text-align:right;'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            <label class="col-lg-5 col-md-3 control-label"><span class="red" style="color:red">* </span>Khata No.</label>
                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::text('survey[khata_no]', isset($survey_data['khata_no']) ? round($survey_data['khata_no'],3) : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Khata Number','id'=>'purchased_area','style'=>'text-align:right;'))); ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="classificationList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                ...
                                <?php echo e(Form::select('survey[classification]', isset($plot_classification) ?$plot_classification : '' , isset($survey_data['classification']) ? $survey_data['classification'] : '',array('class'=>'form-control select2-minimum required'))); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group subclassificationList">
                            ...
                            <label class="col-lg-5 col-md-3 control-label">Physical Verification</label>
                            

                            <div class="col-lg-7 col-md-9">
                                <?php echo e(Form::textarea('survey[physical_verification]', isset($survey_data['physical_verification']) ? $survey_data['physical_verification'] : '', array('class'=>'form-control','placeholder' => 'Physical Verification','size' => '30x3'))); ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <label class="col-lg-5 col-md-3 control-label" style="color: #db5565" id='total_area_in_level'><?= round($reg_data['tot_area'],3); ?></label>
                        </div>
...
<?php /**PATH C:\wamp64\www\dalmialamsv1\resources\views/admin/LandEntryManagement/SurveyOnDetails/form.blade.php ENDPATH**/ ?>