...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <?php echo Form::open(['url' => url('user-management/audit/submit-data'),'class' => 'form-horizontal user-form','method' => 'POST', 'enctype' => 'multipart/form-data','form' => 'form']); ?>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        <?php echo e(Form::text('auditmaster[sort_order]', isset($audit_info['sort_order']) ? $audit_info['sort_order'] : '', array('class'=>'form-control required','placeholder' => 'Sort Order'))); ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        <?php echo e(Form::text('auditmaster[description]', isset($audit_info['description']) ? $audit_info['description'] : '', array('class'=>'form-control required','placeholder' => 'Description'))); ?>
...
<?php } ?>
<?php /**PATH C:\wamp64\www\dalmia_lams\resources\views/admin/AuditManagement/form.blade.php ENDPATH**/ ?>