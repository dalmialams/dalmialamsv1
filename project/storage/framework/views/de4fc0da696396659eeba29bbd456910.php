                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                    ...
                    <div class="col-lg-2 col-md-2">
                        <select class="form-control select2 select2-minimum"  name="user[]" multiple placeholder="Users">
                            ...
                            ?>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ulist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
?>>MIS</option>
        ...
        <table id="master_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $infos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    $results_user = DB::select(($sql_block));                    
                    ?>
                    <td><?= isset($results_user[0]->user_name)? $results_user[0]->user_name:'' ?></td>
                    ...
                    <td>
                        ...
                        foreach ($mis_details as $key => $value) {
                            ...
                            if ($value['name'] == "district") {
                                ...
                                $results = DB::select(($sql_district));
                                if ($key < count($mis_details) - 1) {
...
<?php echo $__env->make('admin.layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dalmia_lams\resources\views/admin/MasterDataManagement/searchLog.blade.php ENDPATH**/ ?>