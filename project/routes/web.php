...
Route::post('/submit-forgot-password', 'ForgotPasswordController@processData');
...
Route::group(['prefix' => 'land-details-entry/registration', 'middleware' => ['auth', 'authRegNum', 'check_permission:registration_access'], 'namespace' => 'LandEntryManagement'], function () {
    ...
    Route::get('csrf', ['as' => '', 'uses' => 'RegistrationController@get_sap_csrf_token'])->middleware(['check_permission:registration_add']);
    Route::post('data', ['as' => '', 'uses' => 'RegistrationController@post_data_to_sap'])->middleware(['check_permission:registration_add']);
    Route::get('sync', ['as' => '', 'uses' => 'RegistrationController@sync'])->middleware(['check_permission:registration_add']);
...
Route::group(['prefix' => 'land-details-entry/land-document', 'middleware' => ['auth', 'check_permission:land_document_access'], 'namespace' => 'LandDocumentManagement'], function () {

    Route::get('add', ['as' => '', 'uses' => 'LandDocumentController@add'])->middleware(['check_permission:land_document_add']);

    Route::get('edit/{land_doc_id?}', ['as' => '', 'uses' => 'LandDocumentController@edit'])->middleware(['check_permission:land_document_edit']);

    Route::any('list', ['as' => '', 'uses' => 'LandDocumentController@LandDocumentList']);
    //->middleware(['auth_patta_search', 'check_permission:land_document_search']);

    Route::post('submit-data', ['as' => '', 'uses' => 'LandDocumentController@processData']);

    Route::any('view', ['as' => '', 'uses' => 'LandDocumentController@view'])->middleware(['check_permission:land_document_view']);

    Route::post('delete', ['as' => '', 'uses' => 'LandDocumentController@deleteLandDoc'])->middleware(['check_permission:land_document_delete']);
});
...
Route::group(['prefix' => 'master/property', 'middleware' => ['auth', 'check_permission:master_property_access'], 'namespace' => 'MasterDataManagement'], function () {
    Route::get('management/edit/{id}', ['as' => '', 'uses' => 'PropertyController@edit']);
    Route::get('management/add', ['as' => '', 'uses' => 'PropertyController@add']);
    Route::get('management', ['as' => '', 'uses' => 'PropertyController@propertyList']);
    Route::post('submit-data', ['as' => '', 'uses' => 'PropertyController@processData']);
});
...
Route::post('get-cities-by-state', ['as' => '', 'uses' => 'Controller@get_citys_by_state']);


Route::group(['prefix' => '/', 'namespace' => 'MasterDataManagement'], function () {
    Route::get('/', function () {
        // echo Hash::check("123456", '$2y$10$YhIV0u8g/sk09vZ4pwh2l.4xB6d1pC0tnLh/uvvVgVqKaT2Lx3KyK');
...
Route::any('contact', 'ContactManagement\ContactManageController@index')->middleware(['auth']);
...
Route::group(['prefix' => 'mis', 'middleware' => ['auth']], function () {
    ...
    Route::any('land_inspection', ['as' => '', 'uses' => 'MisController@land_inspection']);
    Route::any('mortgage_land', ['as' => '', 'uses' => 'MisController@mortgage_land']);
    ...
    Route::get('test-phpmail-send', ['uses' => 'MisController@test_mail']);
    Route::post('submit-data', ['as' => '', 'uses' => 'MasterUserController@processData']);
});
//Clear Config cache:
...
Route::get('auth/sso', ['uses' => 'LoginController@loginWithSSO']);
