...
@section('content')
    ...
    <head>
		...
		<link href="{{url('assets/css/ol.css')}}" rel="stylesheet" type="text/css"/>
        <link href="{{url('assets/css/vector.css')}}" rel="stylesheet" type="text/css"/>
...
.ui-widget input, .ui-widget select, .ui-widget textarea, .ui-widget button {
    ...
    font-size: 0.9em !important;
        ...
        <link href="{{url('assets/frontend/css/flaticon/flaticon.css')}}" rel="stylesheet" type="text/css"/>
		<link href="{{url('assets/frontend/css/flaticon2/flaticon.css')}}" rel="stylesheet" type="text/css"/>
...
<div id="multi_selection_dialog" title="Multi Selection" style="display:none">
	...
	<div class="row">
		...
		<script src="{{url('assets/js/ol.js')}}" type="text/javascript"></script>
		
		<script src="{{url('assets/js/measure.js')}}"></script>
