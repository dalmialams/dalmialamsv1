...
<head>
    ...
    <link href="{{ url('assets/css/custom_style.css') }}" rel="stylesheet" type="text/css" />
    <!-- END CSS TEMPLATE -->
...
<body class="error-body no-top lazy body_login" data-original="{{ url('assets/img/login_bg.png') }}"
                        ...
                        <div class="grey p-t-0 p-b-20 text-black" style="width: 100%;padding-top: 194px !important;">
                            ...
                            <div class=" p-t-0 p-l-40 p-b-0 xs-p-t-10 xs-p-l-10 xs-p-b-10">
                                <div class="dalmia_login_logo p-b-10"><img
                                        src="{{ url('assets/img/dalmia_logo.png') }}" style="margin-top: -315px;"
                                        alt="Dalmia Lams" /></div>
                            ...
                            <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10 clerfix">
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        {{ Form::text('user_name', '', ['class' => 'form-control required', 'id' => 'login_username', 'placeholder' => 'User Name']) }}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
    ...
    <script src="{{ url('assets/plugins/jquery-lazyload/jquery.lazyload.min.js') }}" type="text/javascript"></script>
