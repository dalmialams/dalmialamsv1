...
//                                }
    ...
    <?php } else { ?>
        <div class="panel-body">
            {!! Form::open(['url' => url('land-details-entry/patta/submit-data'),'class' => 'form-horizontal patta-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('patta_id', isset($patta_data['patta_id']) ? $patta_data['patta_id'] : '', array('class'=>'form-control','disabled' => '','placeholder' => 'Patta ID No')) }}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('patta[state_id]', isset($states) ?$states : '' , isset($patta_data['state_id']) ? $patta_data['state_id'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val())'))}}
                        </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                        ...
                        <div class="col-lg-7 col-md-9">                       
                            {{Form::select('patta[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , isset($patta_data['district_id']) ? $patta_data['district_id'] : '',array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))}}
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            {{Form::select('patta[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , isset($patta_data['block_id']) ? $patta_data['block_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))}}
                        </div>
                    </div>
                </div>
                <!-- End .row -->
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('patta[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($patta_data['village_id']) ? $patta_data['village_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateSurvey("",$(this).val())'))}}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        <label class="col-lg-5 col-md-3 control-label"><span class="red" style="color:red">* </span>Patta no.</label>
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('patta[patta_no]', isset($patta_data['patta_no']) ? $patta_data['patta_no'] : '', array('class'=>'form-control required','placeholder' => 'Patta no.')) }}
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('patta[patta_owner]', isset($patta_data['patta_owner']) ? $patta_data['patta_owner'] : '', array('class'=>'form-control required','placeholder' => 'Patta owner')) }}
                        </div>
                    </div>
                </div>
            </div>
