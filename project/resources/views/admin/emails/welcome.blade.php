    ...
    <body>
        ...
        <div class="wrapper_mail">
            ...
            <div class="mail_body">
                ...
                <p>Welcome to Dalmia</p>
                <p>You have been registered as a <strong><?= App\Models\Role\Role::where(['id' => $user['role_id']])->value('display_name') ?></strong> level user</p>
                <p>Please find your login credentials</p>
