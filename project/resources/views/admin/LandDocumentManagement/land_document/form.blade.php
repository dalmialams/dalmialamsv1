...
<div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
    ...
    <!-- Start .panel -->
        ...
        <div class="panel-body">
            {!! Form::open(['url' => url('land-details-entry/land-document/submit-data'),'class' => 'form-horizontal land-document-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
            ...
            <div class="col-lg-12">
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('land_document[document_no]', isset($land_document_data['document_no']) ? $land_document_data['document_no'] : '', array('class'=>'form-control','placeholder' => 'Document ID ')) }}
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('land_document[document_type_id]', isset($document_type_list) ?$document_type_list : '' , isset($land_document_data['document_type_id']) ? $land_document_data['document_type_id'] : '',array('class'=>'form-control select2-minimum required' ))}}
                        </div>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('land_document[property_id]', isset($property_id_list) ?$property_id_list : '' , isset($land_document_data['property_id']) ? $land_document_data['property_id'] : '',array('class'=>'form-control select2-minimum required' ))}}
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group ">
                        ...
                        <div class="col-lg-7 col-md-9">                       
                            {{ Form::text('land_document[physical_file_loaction]', isset($land_document_data['physical_file_loaction']) ? $land_document_data['physical_file_loaction'] : '', array('class'=>'form-control','placeholder' => 'Physical File Location')) }}
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group ">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            {{ Form::text('land_document[locker_no]', isset($land_document_data['locker_no']) ? $land_document_data['locker_no'] : '', array('class'=>'form-control','placeholder' => 'Locker Number')) }}
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group ">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            {{ Form::text('land_document[uploaded_by]', isset($user_name) ? $user_name : '', array('class'=>'form-control','readonly' => '','placeholder' => 'Uploaded By ')) }}
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group ">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            ...
                            {{ Form::date('land_document[uploaded_date]', isset($land_document_data['uploaded_date']) ? date('Y-m-d', strtotime($land_document_data['uploaded_date'])):'', array('class'=>'form-control ','placeholder' => 'Date of Upload')) }}
                                                    ...
                                                    <tbody class="append">
                                                            ...
                                                            @foreach ($document_list as $key => $value)
                                                                <tr class="parent_tr">
                                                                    ...
                                                                    <td class="text-center"><a href="{{ url($land_document_data['file_path'].$value) }}" target="_blank"><i class="ace-icon fa fa-download bigger-130"></i></a> </td> 
                                                                </tr>
