    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary  toggle panelMove">
            ...
            <div class="panel-body">
                {!! Form::open(['url' => url('land-details-entry/land-document/list'),'class' => 'form-horizontal land-doc-form','method' => 'GET', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" >
                            ...
                            <div class="col-lg-7 col-md-9">
                               {{Form::select('land_document[search_document_type_id]', isset($document_type_list) ?$document_type_list : '' , isset($search_document_type_id) ? $search_document_type_id : '',array('class'=>'form-control select2-minimum ' ))}}
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group ">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                {{ Form::text('land_document[search_document_id]', isset($search_document_id) ? $search_document_id : '', array('class'=>'form-control','placeholder' => 'Document ID ')) }} 
                            </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" >
                            ...
                            <div class="col-lg-7 col-md-9">
                               {{Form::select('land_document[search_property_id]', isset($property_id_list) ?$property_id_list : '' , isset($search_property_id) ? $search_property_id : '',array('class'=>'form-control select2-minimum ' ))}}
                            </div>
                                ...
                                foreach ($land_document_list as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        if ($user_type == 'admin' || (\App\Models\UtilityModel::ifHasPermission('land_document_view', $current_user_id) && \App\Models\UtilityModel::ifHasPermission('land_document_access', $current_user_id))) {
                                            ?>
                                            <td  class="text-center"><a href="<?= url('land-details-entry/land-document/view?land_doc_id=' . encrypt($value['land_doc_id']) . '&view=true'); ?>" > {{ $value['document_no']}} </a></td>                                 
                                        <?php } else { ?>
                                            <td  class="text-center"> {{ $value['document_no']}} </td>
                                        <?php } ?>

                                        <td  class="text-center">{{$value['document_type_name']}}</td>
                                        </td>

                                        <td  class="text-center"> {{$value['property_name']}}
                                        </td>

                                        <td  class="text-center"> {{$value['physical_file_loaction']}}
                                        </td>

                                        <td  class="text-center">{{$value['locker_no']}}</td>
                                        </td>
           
                                        <td  class="text-center"> {{ $value['uploaded_by'] }} </td>

                                        <td  class="text-center"> {{ isset($value['uploaded_date']) ? date('d-m-Y', strtotime($value['uploaded_date'])):'' }}  </td>
                                        ...
                                        <td  class="text-center"><div class="action-buttons">
                                                ...
                                                if ($user_type == 'admin' || (\App\Models\UtilityModel::ifHasPermission('land_document_delete', $current_user_id) && \App\Models\UtilityModel::ifHasPermission('land_document_access', $current_user_id))) {
                                                    ...
                                                    <a title="Delete" href="javascript:void(0);" onclick="delete_param('{{ encrypt($value['land_doc_id']) }}');">
