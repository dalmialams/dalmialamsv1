            ...
            <div class="col-lg-12">
                <div class="row ">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('registration[sap_asset_code]', isset($reg_data['sap_asset_code']) ? $reg_data['sap_asset_code'] : '', array('class'=>'form-control paymentValidate','placeholder' => 'SAP Asset Code','id'=>'sap_asset_code')) }}
                        </div>
                    </div>
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        <label class="col-lg-5 col-md-3 control-label"><span class="red" style="color:red">* </span>SAP Company Code</label>
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('registration[sap_company_code]', isset($reg_data['sap_company_code']) ? $reg_data['sap_company_code'] : '', array('class'=>'form-control paymentValidate','placeholder' => 'SAP Company Code','id'=>'sap_company_code')) }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="row ">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="row" style="margin-left:0px;">
                                <div class="col-sm-6 form-group">
                                    {{Form::select('registration[tot_area_unit]', isset($area_units) ? $area_units : '', isset($reg_data['tot_area_unit']) ? $reg_data['tot_area_unit'] : '',array('class'=>'form-control select2-minimum required' , 'disabled' => 'true'))}}
                                </div>
                                <div class="col-sm-6 form-group" style="margin-left:30px;">
                                    {{ Form::text('registration[tot_area]', isset($reg_data['tot_area']) ? number_format($reg_data['tot_area'], 4) : '', array('class'=>'form-control required ','placeholder' => '','style'=>'text-align:right', 'disabled' => 'true')) }}
                                </div>															
                            </div>															
                    ...
                    {{-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('registration[tot_cost]', isset($reg_data['tot_cost']) ? $reg_data['tot_cost'] : '', array('class'=>'form-control required numbers_only_restrict','placeholder' => 'Total Cost','style'=>'text-align:right', 'disabled' => 'true')) }}
