                    ...
                    <table id="registration_lists_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                foreach ($registration as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;" class="all_total_area"><?php
                                            $valueToDisplay = ($value->purchased_area_in_acre + $value->leased_area_in_acre);
                                            $cumilativeTitalArea = $cumilativeTitalArea + $valueToDisplay;
                                            echo $valueToDisplay;
                                            ?></td>
                                        <td style="text-align: right;" class="all_total_cost"><?php
                                            $cumilativeTitalCost = $cumilativeTitalCost + $value->payment_sum;
                                            echo $value->payment_sum;
                                            ?></td>
                                        <td>
                                            <?php
                        ...
                        <thead>
                            <tr>
                                ...
                                <th></th>                           
                                <th></th>
                                <th class="text-right all_total_area"><?= isset($sumResult) ? $sumResult[0]->purchased_area_in_acre : '' ?></th>
                                <!--<th>Unit</th>-->
                                <th class="text-right all_total_cost"><?= isset($sumResult) ? $sumResult[0]->total_cost : '' ?></th>
                                <th></th>
                            </tr>
                        </thead>
