...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        {!! Form::open(['url' => url('master-user/submit-data'),'class' => 'form-horizontal user-form','method' => 'POST', 'enctype' => 'multipart/form-data','user' => 'form']) !!}
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('user[name]', isset($user_data['name']) ? $user_data['name'] : '', array('class'=>'form-control required','placeholder' => 'Name')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('user[email]', isset($user_data['email']) ? $user_data['email'] : '', array('class'=>'form-control required','placeholder' => 'Email')) }}
                    </div>
