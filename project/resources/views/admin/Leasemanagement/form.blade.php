...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            {!! Form::open(['url' => url('lease-management/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('lease[registration_id]', isset($reg_id_arr) ? $reg_id_arr : '', isset($lease_data['registration_id']) ? $lease_data['registration_id'] : '',array('class'=>'form-control select2-minimum required','onchange'=>'populateFields($(this).val())'))}}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
    ...
    <!--                                    <input type="text" class="form-control" name="start" />-->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{ Form::text('lease[percentage_escalation]', isset($lease_data['percentage_escalation']) ? $lease_data['percentage_escalation'] : '', array('class'=>'form-control numbers_only_restrict required','placeholder' => 'Escalation %')) }}
                        </div>
                    </div>
