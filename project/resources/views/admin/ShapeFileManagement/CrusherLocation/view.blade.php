...
<a style="float:right" class="btn btn-primary" href="<?= url('document-management/document/crusher-location') ?>">Shape Zip List</a>
</div>
	...
	<a class="btn btn-success" onclick="return confirm('Are you sure to import shape file?')" href="<?= url('document-management/document/importShp/'.$table_name.'/crusher_location/'.$data_id) ?>"><i class="fa fa-external-link-square" aria-hidden="true"></i> Import Shape File</a>
	
	<a class="btn btn-info" onclick="return confirm('Are you sure to export shape file?')" href="<?= url('document-management/document/data-export-shp/'.$table_name.'/crusher_location/'.$data_id) ?>"><i class="fa fa-external-link-square" aria-hidden="true"></i> Export Shape File</a>
...
var parcel_boundry_url = '<?php echo URL("document-management/document/shape-map-view/crusher-location/");?>/<?= $table_name ?>';
