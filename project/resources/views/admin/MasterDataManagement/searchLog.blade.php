...
<div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
    ...
    <div class="panel-body">
        <!-- -->
        {!! Form::open(['url' => url('master/search/search-log'),'class' => 'form-horizontal contact-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form','autocomplete'=>'off']) !!}
        <div class="col-lg-12">
            <div class="row ">
        ...
        <table id="master_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{isset($infos->mis_type)? $infos->mis_type : ''}}</td>
