    ...
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('hypothecation[trxn_type]', isset($type) ?$type : '' , '' ,array('class'=>'form-control select2-minimum trxn_type','onchange' => 'populateResistration($(this).val())'))}}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group registration_id">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('registration_id[]', isset($all_registrationIds) ?$all_registrationIds : '' ,  '',array('class'=>'form-control select2-minimum','multiple'=>'multiple'))}}
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Hypothecate With</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('hypothecation[hyp_with]', isset($hypothecate_with) ?$hypothecate_with : '' , '' ,array('class'=>'form-control select2-minimum required'))}}
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        ...
                        {{ Form::text('hypothecation[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('hypothecation[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'disputes') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('disputes[litigation_type]', isset($litigation_type) ?$litigation_type : array('' => 'Select') , '',array('class'=>'form-control select2-minimum ','onchange' => ''))}}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('disputes[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('disputes[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'land_ceiling') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Transaction type</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_ceiling[trxn_type]', isset($type) ?$type : array('' => 'Select') , '',array('class'=>'form-control select2-minimum trxn_type','onchange' => 'populateSurveyWithTrxnType()'))}}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group ceiling_survey_list" id="survey-list">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_ceiling[survey_id]', isset($all_surveys) ?$all_surveys : '' ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('land_ceiling[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('land_ceiling[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'land_conversion') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Transaction type</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_conversion[trxn_type]', isset($type) ?$type : array('' => 'Select') , '',array('class'=>'form-control select2-minimum trxn_type','onchange' => 'populateSurveyWithTrxnType()'))}}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group conversion_survey_list" id="survey-list">
            <label class="col-lg-5 col-md-3 control-label">Survey No</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_conversion[survey_id]', isset($survey_list) ?$survey_list : '' ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('land_conversion[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('land_conversion[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'land_exchange') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                {{ Form::text('land_exchange[transferee]',  '', array('class'=>'form-control','placeholder' => 'Transferee')) }}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('land_exchange[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('land_exchange[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'land_inspection') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_inspection[encroachment]', isset($encroachment_info) ?$encroachment_info : array('' => 'Select') , '',array('class'=>'form-control select2-minimum ','onchange' => ''))}}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Encroachment Type</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_inspection[encroachment_type]', isset($encroachment_type) ?$encroachment_type : array('' => 'Select') , '',array('class'=>'form-control select2-minimum ','onchange' => ''))}}
            </div>
        </div>  
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('land_inspection[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('land_inspection[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'land_reservation') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Transaction type</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_reservation[trxn_type]', isset($type) ?$type : array('' => 'Select') , '',array('class'=>'form-control select2-minimum trxn_type','onchange' => 'populateSurveyWithTrxnType()'))}}
            </div>
        </div> 
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group reservation_survey_list" id="survey-list">
            <label class="col-lg-5 col-md-3 control-label">Survey No</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('land_reservation[survey_id]', isset($survey_list) ?$survey_list : '' ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>      
    </div>
    <div class="row"> 
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('land_reservation[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('land_reservation[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'payment') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('payment[payment_type]', isset($payment_type) ?$payment_type : '' , '' ,array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Transaction Date (From - To)</label>
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('payment[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('payment[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="payement_reg_list">
            <label class="col-lg-5 col-md-3 control-label">Registration No.</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('payment[registration_id]', isset($all_registrationIds) ?$all_registrationIds : '' ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>
    </div>
<?php } else if ($transaction_type == 'under_operation') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('under_operation[operation_type]', isset($operation_type) ?$operation_type : '' , '' ,array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>  
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Transaction  Date (From - To)</label>
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('under_operation[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('under_operation[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'mutation') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group old_patta_list">
            ...
            <div class="col-lg-7 col-md-9">
                {{Form::select('mutation[patta_id]', isset($old_patta_no) ?$old_patta_no : '' , '' ,array('class'=>'form-control select2-minimum','onchange' => 'populatePattaSurvey($(this).val())'))}}
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group mutation_survey_list" id="survey-list">
            <label class="col-lg-5 col-md-3 control-label">Survey No</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('mutation[survey_id]', array('' => 'Select') ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>
    </div>
    <div class="row">   
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('mutation[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('mutation[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'mining_lease') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Transaction Type</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('mining_lease[trxn_type]', isset($type) ?$type : '' , '' ,array('class'=>'form-control select2-minimum trxn_type','onchange' => 'populateSurveyWithTrxnType()'))}}
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group minning_survey_list" id="survey-list">
            <label class="col-lg-5 col-md-3 control-label">Survey No</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('mining_lease[survey_id]', isset($survey_list) ?$survey_list : '' ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>
    </div>
    <div class="row"> 
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('mining_lease[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('mining_lease[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
...
<?php } else if ($transaction_type == 'lease') { ?>
    <div class="row"> 
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('lease[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('lease[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="lease_reg_list">
            <label class="col-lg-5 col-md-3 control-label">Registration No.</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('lease[registration_id]', isset($all_registrationIds) ?$all_registrationIds : '' ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>
    </div>
<?php } else if ($transaction_type == 'coversion_parent') { ?>
    <div class="row">                      
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="conversion_parent_list">
            <label class="col-lg-5 col-md-3 control-label">Registration No.</label>
            <div class="col-lg-7 col-md-9">
                {{Form::select('coversion_parent[registration_id]', isset($all_registrationIds) ?$all_registrationIds : '' ,  '',array('class'=>'form-control select2-minimum'))}}
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
            <label class="col-lg-5 col-md-3 control-label">Transaction  Date (From - To)</label>
            <div class="col-lg-7 col-md-9">
                <div class="input-group">
                    <div class="input-daterange input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        {{ Form::text('coversion_parent[date_from]',  '', array('class'=>'form-control  start_date','placeholder' => 'From')) }}
                        <span class="input-group-addon">to</span>
                        {{ Form::text('coversion_parent[date_to]',  '', array('class'=>'form-control  end_date','placeholder' => 'To')) }}
                    </div>
                </div>
            </div>
        </div>
