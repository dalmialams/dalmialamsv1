...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(['url' => url('user-management/user/submit-data'),'class' => 'form-horizontal user-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
            <div class="col-lg-12">
                <div class="row ">
                    <!-- Start .row -->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php if (isset($id) && $id) { ?>
                                {{ Form::text('', isset($user_data['user_name']) ? $user_data['user_name'] : '', array('class'=>'form-control','readonly' => 'true')) }}
                            <?php } else { ?>
                                {{Form::select('user[user_name][]', isset($user_list) ? $user_list : '', isset($user_data['user_name']) ? $user_data['user_name'] : '',array('class'=>'form-control select2-minimum required','multiple' => '' ))}}
                            <?php } ?>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('user[role_id]', isset($roles) ? $roles : '', isset($user_data['role_id']) ? $user_data['role_id'] : '',array('class'=>'form-control select2-minimum required'))}}
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            ...
                            {{Form::select('user[fl_archive]', isset($status) ? $status : '', isset($user_data['fl_archive']) ? $user_data['fl_archive'] : '',array('class'=>'form-control select2-minimum required'))}}
    ...
    <!--                                    <input type="text" class="form-control" name="start" />-->
                                    {{ Form::text('user[start_date]', isset($user_data['start_date']) ? date("d/m/Y",strtotime($user_data['start_date'])) : '', array('class'=>'form-control required','placeholder' => 'Start Date','id' => 'start_date')) }}
                                    <span class="input-group-addon">to</span>
                                    {{ Form::text('user[end_date]', isset($user_data['end_date']) ? date("d/m/Y",strtotime($user_data['end_date'])) : '', array('class'=>'form-control required','placeholder' => 'End Date','id' => 'end_date')) }}
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                foreach ($master_access_rights as $m_key => $m_value) {
                                                    if (in_array($m_key, $access_rights)) {
                                                        ...
                                                        if ($user_crt_type == 'admin') {
                                                            ?>
                                                            <td  class="text-center"> {{ Form::checkbox($name_field, '',(in_array($permission_name,$permissions)) ? true :false)}}</td>
                                                            <?php
                                                        } else {
