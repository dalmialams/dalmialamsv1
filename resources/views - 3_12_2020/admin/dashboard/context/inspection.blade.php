                    ...
                    <table id="tabletools1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th  class="text-center">To be inspected (Acre)</th>
                                <th  class="text-center">Inspected  (Acre)</th>
                                <th  class="text-center">Encroached  (Acre)</th>
                                <th  class="text-center">Encroachment free  (Acre)</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="all_total_area" style="text-align: right;"><?= $survey_total_area_details['total_under_operation_area_acre'] ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= $total_area_details['grand_total_tot_area_acer'] - $survey_total_area_details['total_under_operation_area_acre'] ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= $survey_total_area_details['total_inspected_area_acre'] ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= $survey_total_area_details['total_encroached_area_acre'] ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= $survey_total_area_details['total_encroached_free_area_acre'] ?></td>
                            </tr>
