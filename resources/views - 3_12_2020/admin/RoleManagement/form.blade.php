...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        {!! Form::open(['url' => url('user-management/role/submit-data'),'class' => 'form-horizontal user-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('role[name]', isset($role_data['display_name']) ? $role_data['display_name'] : '', array('class'=>'form-control required','placeholder' => 'Role Name')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{Form::select('role[status]', isset($status) ? $status : '', isset($role_data['status']) ? $role_data['status'] : '',array('class'=>'form-control select2-minimum required'))}}
                    </div>
