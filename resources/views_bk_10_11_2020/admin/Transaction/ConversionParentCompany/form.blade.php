...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            {!! Form::open(['url' => url('transaction/conversion-parent-company/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('conversionParCmp[purchaser]', isset($purchase) ? $purchase : '', isset($reg_data['purchaser']) ? $reg_data['purchaser'] : '',array('class'=>'form-control select2-minimum required','id'=>'purchaser_name','onchange' => 'populateRegistration()'))}}
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">                       
                            {{Form::select('conversionParCmp[sub_registrar]', isset($sub_registrar_office) ? $sub_registrar_office : '', isset($reg_data['sub_registrar']) ? $reg_data['sub_registrar'] : '',array('class'=>'form-control select2-minimum required','id'=>'sub_registrar','onchange' => 'populateRegistration()'))}}
                        </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <!--                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                                            ...
                                            <div class="col-lg-7 col-md-9">
                                                {{Form::select('conversionParCmp[village_id]', isset($villages) ? $villages : array('' => 'Select') , isset($mutation_data['village_id']) ? $mutation_data['village_id'] : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateRegistration()','id'=>'village_id'))}}
                                            </div>
                                        </div>-->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <div class="col-lg-7 col-md-9">  
                            {{Form::select('conversionParCmp[legal_entity]', isset($legal_entry) ? $legal_entry : '', isset($reg_data['legal_entity']) ? $reg_data['legal_entity'] : '',array('class'=>'form-control select2-minimum required'))}}
                        </div>
                    </div>
                </div>
                <!-- End .row -->
