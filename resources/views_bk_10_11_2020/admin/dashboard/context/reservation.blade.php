                    ...
                    <table id="tabletools1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th  class="text-center">Reserved (Acre)</th>
                                <th  class="text-center">Unreserved    (Acre)</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="all_total_area" style="text-align: right;"><?= $survey_total_area_details['total_reserved_area_acre'] ?></td>
                                <td class="all_percentage" style="text-align: right;"><?= $survey_total_area_details['total_unreserved_area_acre'] ?></td>
                            </tr>
