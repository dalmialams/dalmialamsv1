                    ...
                    <table id="tabletools1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th  class="text-center">Mutation done (Acre)</th>
                                <th  class="text-center">Mutation pending (Acre)</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="all_total_area" style="text-align: right;"><?= $survey_total_area_details['grand_total_mutated_area_acre'] ?></td>
                                <td class="all_percentage" style="text-align: right;"><?= $total_area_details['grand_total_tot_area_acer'] - $survey_total_area_details['grand_total_mutated_area_acre'] ?></td>
                                <td class="" style="text-align: right;">
                                    <?php
                                    $pending_area = $total_area_details['grand_total_tot_area_acer'] - $survey_total_area_details['grand_total_mutated_area_acre'];
