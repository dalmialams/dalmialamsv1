                ...
                <table class="table  table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  class="text-center"><?= $reg_data['regn_date'] ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td  class="text-center" style="text-align: right;"><?= number_format($reg_data['tot_cost']) ?></td>
                        </tr>
                        <tr>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <div class="input-group paymentValidate">
                                ...
                                {{ Form::text('registration[regn_date]', isset($reg_data['regn_date']) ? $reg_data['regn_date'] : '', array('class'=>'form-control required','placeholder' => 'Date','id'=>'basic-datepicker')) }}
                            </div>
                        </div>
                    </div>
