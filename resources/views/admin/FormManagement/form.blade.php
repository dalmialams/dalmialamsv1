...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        {!! Form::open(['url' => url('user-management/form/submit-data'),'class' => 'form-horizontal user-form','method' => 'POST', 'enctype' => 'multipart/form-data','form' => 'form']) !!}
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('form[sort_order]', isset($form_data['sort_order']) ? $form_data['sort_order'] : '', array('class'=>'form-control required','placeholder' => 'Sort Order')) }}
                    </div>
                </div>
                <!-- Start .row -->
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('form[form_name]', isset($form_data['form_name']) ? $form_data['form_name'] : '', array('class'=>'form-control required','placeholder' => 'Form Name')) }}
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('form[access_rights]', isset($form_data['access_rights']) ? $form_data['access_rights'] : '', array('class'=>'form-control required','placeholder' => 'Access Rights')) }}
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{Form::select('form[status]', isset($status) ? $status : '', isset($form_data['status']) ? $form_data['status'] : '',array('class'=>'form-control select2-minimum required'))}}
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{Form::select('form[group]', ['' => 'Select','registration' => 'Registration' ,'transaction' => 'Transaction','patta' => 'Patta', 'master data' => 'Master Data'], isset($form_data['group']) ? $form_data['group'] : '',array('class'=>'form-control select2-minimum required'))}}
                    </div>
