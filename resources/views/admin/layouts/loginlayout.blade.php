...
<html>
    ...
    <!-- END HEAD -->
    <!-- BEGIN BODY -->
    <body class="error-body no-top lazy body_login" data-original="{{URL::asset('assets/img/login_bg.png')}}" style="background-image: url('assets/img/login_bg.png'); background-size:100% 100%;">  
                    ...
                    <div class="Aligner">
                        ...
                        <div class="grey p-t-0 p-b-20 text-black" style="width: 100%;padding-top: 194px !important;">
                            ...
                            <div class=" p-t-0 p-l-40 p-b-0 xs-p-t-10 xs-p-l-10 xs-p-b-10"> 
                                <div class="dalmia_login_logo p-b-10"><img src="{{URL::asset('assets/img/dalmia_logo.png')}}" style="margin-top: -315px;" alt="Dalmia Lams" /></div>
