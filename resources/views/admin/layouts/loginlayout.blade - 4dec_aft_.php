                    ...
                    <div class="Aligner">
                        ...
                        <div class="grey p-t-0 p-b-20 text-black" style="width: 100%">
                            ...
                            <div class=" p-t-0 p-l-40 p-b-0 xs-p-t-10 xs-p-l-10 xs-p-b-10"> 
                                <div class="dalmia_login_logo p-b-10"><img src="{{URL::asset('assets/img/dalmia_logo.png')}}" alt="Dalmia Lams" /></div>
                                 <h4 class="normal">Land Information Management System</h4>    
                            ...
                            <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10 clerfix">
                                ...
                                <div class="form-group">  
                                    <div class="col-md-12 col-sm-12">                                       
                                        <a class="pull-right forgot_password p-b-5" href="<?= url('forgot-password') ?>">Forgot password?</a>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
