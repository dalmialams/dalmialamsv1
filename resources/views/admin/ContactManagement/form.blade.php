...
<div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
    ...
    <div class="panel-body">
        ...
        {!! Form::open(['url' => url('contact/submit-data'),'class' => 'form-horizontal contact-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
            ...
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[name]', isset($contact_data['name']) ? $contact_data['name'] : '', array('class'=>'form-control required','placeholder' => 'Name')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[designation]', isset($contact_data['designation']) ? $contact_data['designation'] : '', array('class'=>'form-control required','placeholder' => 'Designation')) }}
                    </div>
        ...
        <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[classification]', isset($contact_data['classification']) ? $contact_data['classification'] : '', array('class'=>'form-control required','placeholder' => 'Classification')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[working_field]', isset($contact_data['working_field']) ? $contact_data['working_field'] : '', array('class'=>'form-control required','placeholder' => 'Related to working field')) }}
                    </div>
        ...
        <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::email('contact[email_id]', isset($contact_data['email_id']) ? $contact_data['email_id'] : '', array('class'=>'form-control required','placeholder' => 'Email id')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[mobile_no]', isset($contact_data['mobile_no']) ? $contact_data['mobile_no'] : '', array('class'=>'form-control required numbers_only_restrict','placeholder' => 'Mobile No.')) }}
                    </div>
        ...
        <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[tel_no]', isset($contact_data['tel_no']) ? $contact_data['tel_no'] : '', array('class'=>'form-control required numbers_only_restrict','placeholder' => 'Residence Tel.')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[address]', isset($contact_data['address']) ? $contact_data['address'] : '', array('class'=>'form-control required','placeholder' => 'Residence Address')) }}
                    </div>
        ...
        <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{Form::select('contact[state_id]', isset($states) ?$states : '' , isset($contact_data['state_id']) ? $contact_data['state_id'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populateCity($(this).val())'))}}
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group cityList">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{Form::select('contact[city]', isset($city_info) ?$city_info : array('' => 'Select') , isset($contact_data['city']) ? $contact_data['city'] : '',array('class'=>'form-control select2-minimum required'))}}
                    </div>
                </div>
        ...
        <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[pin]', isset($contact_data['pin']) ? $contact_data['pin'] : '', array('class'=>'form-control required numbers_only_restrict','placeholder' => 'PIN')) }}
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[importance]', isset($contact_data['importance']) ? $contact_data['importance'] : '', array('class'=>'form-control required numbers_only_restrict check_only_oneinput','placeholder' => 'Importance')) }}
                    </div>
        ...
        <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[effective]', isset($contact_data['effective']) ? $contact_data['effective'] : '', array('class'=>'form-control required numbers_only_restrict check_only_oneinput','placeholder' => 'Effective')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[relationship]', isset($contact_data['relationship']) ? $contact_data['relationship'] : '', array('class'=>'form-control required numbers_only_restrict check_only_oneinput','placeholder' => 'Relationship')) }}
        ...
        <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::text('contact[source]', isset($contact_data['source']) ? $contact_data['source'] : '', array('class'=>'form-control required','placeholder' => 'Lead source in Company')) }}
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <div class="col-lg-7 col-md-9">
                        {{ Form::textarea('contact[remarks]', isset($contact_data['remarks']) ? $contact_data['remarks'] : '', array('class'=>'form-control','placeholder' => 'remarks','size' => '30x3')) }}
