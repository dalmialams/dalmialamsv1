...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            {!! Form::open(['url' => url('transaction/hypothecation/submit-data'),'class' => 'form-horizontal hypothecate-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            <?php if ($id) {
                                ?>
                                {{ Form::text('', isset($hypothecate_data_data['value']) ? $hypothecate_data_data['value'] : '', array('class'=>'form-control required numbers_only_restrict autonumeric','placeholder' => 'Value','style'=>'text-align:right','disabled' => true)) }}
                            <?php } else { ?>
                                {{ Form::text('hypothecate[value]', isset($hypothecate_data_data['value']) ? $hypothecate_data_data['value'] : '', array('class'=>'form-control required numbers_only_restrict','placeholder' => 'Value','style'=>'text-align:right')) }}
                            <?php } ?>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{ Form::textarea('hypothecate[description]', isset($hypothecate_data_data['description']) ? $hypothecate_data_data['description'] : '', array('class'=>'form-control','placeholder' => 'Remarks','size' => '30x1')) }}
                        </div>
                    </div>
                </div>
                                    ...
                                    foreach ($allRegistrationData as $key => $value) {
                                        ...
                                        <tr>
                                            <?php if (file_exists($file_path)) { ?>
                                                <td  class="text-center"> {{ Form::checkbox($name_field, $value['id'],(in_array($check_hypo_rele_doc,$exists_Docs)) ? true :false)}}</td>
                                            <?php } else { ?>
                                                <td></td>
                                            <?php } ?>
...
<?php if (isset($hypothetication_lists) && !empty($hypothetication_lists)) { ?>
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title">Mortgage Land List</h4>
        </div>
        <div class="panel-body">
            <table id="hypothecate_list_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th class="text-center">Mortgage Land No.</th>
                        <th class="text-center">Mortgage Land Name</th>
                        <th class="text-center">Transaction Type</th>
                        <th class="text-center">Registration No.</th>
                        <th class="text-center">Mortgage Land With</th>
