...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            {!! Form::open(['url' => url('transaction/land-ceiling/submit-data'),'class' => 'form-horizontal lease-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
            ...
            <div class="col-lg-12">
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('land_ceiling[trxn_type]', isset($type) ?$type : '' , $trxn_type ,array('class'=>'form-control select2-minimum required trxn_type','onchange' => 'if ($("#village_id").val()) {populateSurvey("",$("#village_id").val()) }'))}}
                            </div>
                        <?php } ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('land_ceiling[state_id]', isset($states) ?$states : '' , $state_id ,array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val())'))}}
                            </div>
                        <?php } ?>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">                       
                                {{Form::select('land_ceiling[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , $district_id ,array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))}}
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">  
                                {{Form::select('land_ceiling[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , $block_id ,array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))}}
                            </div>
                        <?php } ?>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                        ...
                        <?php } else { ?>
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('land_ceiling[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , $village_id,array('class'=>'form-control select2-minimum ','onchange' => 'populateSurvey("",$(this).val())','id' => 'village_id'))}}
                            </div>
                        <?php } ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group survey_id">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('land_ceiling[survey_id]', isset($survey_info) ? $survey_info : array('' => 'Select') , isset($land_ceiling_data['village_id']) ? $land_ceiling_data['village_id'] : '',array('class'=>'form-control select2-minimum','id' => 'survey_id'))}}
                        </div>
                    </div>
                </div>
                <!-- End .row -->
