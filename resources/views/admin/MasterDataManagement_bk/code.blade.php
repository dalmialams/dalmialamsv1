        ...
        <table id="master_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    ?>
                    <th  class="text-center">Action <a href="{{ url('master/code/management/add')}}" class="btn btn-info pull-right">Add</a></th>
...
//                t($codeList,1);
                ...
                <!-- <td  class="text-center"><?php
                            ...
                            <?php } ?>
                            <td  class="text-center"><a href="{{URL::to('master/code/management/edit/'.$value->id)}}"   ><i class="ace-icon fa fa-pencil bigger-130"></i></a></td>
