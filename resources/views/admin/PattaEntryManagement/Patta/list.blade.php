    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary  toggle panelMove">
            ...
            <div class="panel-body">
                {!! Form::open(['url' => url('land-details-entry/patta/list'),'class' => 'form-horizontal reg-form','method' => 'GET', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="stateList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('patta[state_id]', isset($states) ?$states : '' , isset($state_id) ? $state_id : '',array('class'=>'form-control select2-minimum','onchange' => 'populateDistrict($(this).val())'))}}
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group districtList">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                {{Form::select('patta[district_id]', isset($district_info) ?$district_info : array('' => 'Select') , isset($district_id) ? $district_id : '',array('class'=>'form-control select2-minimum','onchange' => 'populateBlock($(this).val())'))}}
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group block-list">
                            ...
                            <div class="col-lg-7 col-md-9">                       
                                {{Form::select('patta[block_id]', isset($block_info) ?$block_info : array('' => 'Select') , isset($block_id) ? $block_id : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateVillage($(this).val())'))}}
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('patta[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($village_id) ? $village_id : '',array('class'=>'form-control select2-minimum ','onchange' => 'populateSurvey("",$(this).val())'))}}
                            </div>
                        </div>                                       
                    </div>
                    <!-- End .row -->
                ...
                <div class="col-lg-12">
                    <div class="row">                      
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{-- Form::text('patta[patta_no]', isset($patta_no) ? $patta_no : '', array('class'=>'form-control required','placeholder' => 'Patta no.')) --}}
                                {{Form::select('patta[patta_no]', isset($patta_no_info) ? $patta_no_info : array('' => 'Select'), isset($patta_no) ? $patta_no : '',array('class'=>'form-control select2-minimum '))}}
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::text('patta[patta_owner]', isset($patta_owner) ? $patta_owner : '', array('class'=>'form-control required','placeholder' => 'Patta owner')) }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::text('patta[id]', isset($id) ? $id : '', array('class'=>'form-control required','placeholder' => 'Patta ID No')) }}
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group survey-list">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('survey_id[]', isset($survey_info) ? $survey_info : array('Select' => '') , isset($survey_id) ? $survey_id : '',array('class'=>'form-control select2-minimum ','multiple' => 'true'))}}
                            </div>
                        </div> 
                    </div>
                </div>
