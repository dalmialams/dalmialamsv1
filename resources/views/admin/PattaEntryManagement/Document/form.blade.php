...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            <?php if ($reg_uniq_no) { ?>
                {!! Form::open(['url' => url('land-details-entry/document/submit-data'),'class' => 'form-horizontal document-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}       
                <div class="col-lg-12">
                    <div class="row">
                        <!-- Start .row -->
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('document[type]', isset($document_type) ? $document_type : '', isset($doc_data['type']) ? $doc_data['type'] : '',array('class'=>'form-control select2-minimum required'))}}
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::text('document[physical_location]', isset($doc_data['physical_location']) ? $doc_data['physical_location'] : '', array('class'=>'form-control required','placeholder' => 'Physical Location')) }}
                            </div>
                        </div>
                    </div>
                    <!-- End .row -->
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::text('document[remarks]', isset($doc_data['remarks']) ? $doc_data['remarks'] : '', array('class'=>'form-control','placeholder' => 'Remarks')) }}
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                <button type="submit" value="save" name="save_doc" class="btn btn-success">Save</button>
                                <button type="submit" value="save_continue" name="save_doc" class="btn btn-primary">Save & Continue</button>
                                <?php if (count($all_docs) > 0) { ?>
                                    <a href="<?= url('land-details-entry/payment/add?reg_uniq_no=' . $reg_uniq_no) ?>"><button type="button" class="btn btn-warning">Skip</button></a>
                                <?php } else { ?>
                                        ...
                                        <?php if (!$viewMode) { ?>
                                            <td>
                                                <div class="action-buttons">
                                                    <a title="Edit" href="<?= url('land-details-entry/document/add?reg_uniq_no=' . $reg_uniq_no . '&doc_id=' . $value['id']) ?>">
