		 ...
		 <div class="col-lg-12">
            <div class="row ">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                    ...
                    <div class="col-lg-10 col-md-9">
						  {{Form::select('state[map_exists]', ['N'=>'No','Y'=>'Yes'] , isset($stateDetails['map_exists']) ? $stateDetails['map_exists'] : '',array('class'=>'form-control select2-minimum required'))}}
                    </div>
                </div>
            </div>
            <!-- End .row -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                    ...
                    <div class="col-lg-10 col-md-9">
						<!--  {{Form::select('state[fl_archive]', ['N'=>'Yes','Y'=>'No'] , isset($stateDetails['fl_archive']) ? $stateDetails['fl_archive'] : '',array('class'=>'form-control select2-minimum required','onchange' => 'populateDistrict($(this).val(),"village")'))}}-->
						  {{Form::select('state[fl_archive]', ['N'=>'Yes','Y'=>'No'] , isset($stateDetails['fl_archive']) ? $stateDetails['fl_archive'] : '',array('class'=>'form-control select2-minimum required'))}}
                    </div>
                </div>
            </div>
            <!-- End .row -->
