									...
									<div class="col-sm-2 custom_list_on_map">
										<table class="table" id="layer_legend">
											...
											<tbody>	                                              
												<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="parcel_boundry_id" value="parcel_boundry"> <i class="colorpick-btn" style="border:2px solid #8B4513;"></i><span id="parcel_boundry" class="fa fa-search-plus stzoom zoom-to-layer"></span>  Survey</span>
													</td>
											...
											<tbody>	  		
													...
													<tr>
                                                     <td>
														<span><input type="checkbox" class="layer" checked="true" id="lease_boundary_layer_id" value="lease_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #FF0000;"></i><span id="lease_boundary_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span> Mining Lease Boundary</span>
													</td>
													</tr>
													<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="plant_boundary_layer_id" value="plant_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #A52A2A;"></i><span id="plant_boundary_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span> Plant Boundary</span>
													</td>
													</tr>
													
													<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="colony_boundary_layer_id" value="colony_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #006400;"></i><span id="colony_boundary_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span>  Colony Boundary</span>
													</td>
													</tr>
													
													<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="railway_sliding_boundary_layer_id" value="railway_sliding_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #0000FF;"></i><span id="railway_sliding_boundary_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span>  Railway Sliding Boundary</span>
													</td>
													</tr>
													
													<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="approach_road_layer_id" value="approach_road_layer"> <i class="colorpick-btn" style="border:2px solid #000000;"></i><span id="approach_road_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span> Approach Road</span>
													</td>
													</tr>
													
													<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="conveyor_belt_layer_id" value="conveyor_belt_layer"> <i class="colorpick-btn" style="border:2px solid #800080;"></i><span id="conveyor_belt_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span>  Conveyor Belt</span>
													</td>
													</tr>
													
													<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="railway_line_boundary_layer_id" value="railway_line_boundary_layer"> <i class="colorpick-btn" style="border:2px solid #000000;"></i><span id="railway_line_boundary_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span>  Railway Track</span>
													</td>
													</tr>
													
													<tr>
													<td>
														<span><input type="checkbox" class="layer" checked="true" id="crusher_location_layer_id" value="crusher_location_layer"> <i class="colorpick-btn" style="border:2px solid #FFA500;"></i><span id="crusher_location_layer" class="fa fa-search-plus stzoom zoom-to-layer"></span>Crusher Location</span>
													</td>
													</tr>
