                            ...
                            <div class="title_right">
                                <div class="button_group">
                                    <div class="btn-group pull-right">
                                        ...
                                        <button type="button" id="cmd" onclick="window.print()" class="btn btn-info" onclick="printMap()" title="Capture Map">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-original-title="Capture Map">
...
<div id="multi_selection_dialog" title="Multi Selection" style="display:none">
	<div class="row" style="background: #f6f6f6;padding-top: 5px;">
			...
			<div style="float:right;">
				<a onclick="map_draw_feature('Rectangle')"><i class="fa fa-th" aria-hidden="true" style="cursor: pointer;"></i></a>
				<a onclick="map_draw_feature('Polygon')"><i class="fa fa-area-chart" aria-hidden="true" style="margin-left: 6px;cursor: pointer;"></i></a>
				<a onclick="map_draw_feature('Circle')"><i class="fa fa-circle-o" aria-hidden="true"  style="margin-left: 6px;cursor: pointer;"></i></a>
	...
	if (lyr === layers.item(i).get('name')) {
		...
		return;
			...
			source: new ol.source.TileWMS({
				url: 'http://192.168.40.199:8080/geoserver/DALMIA-LAMS/wms',
				params: {
					'FORMAT': 'image/png',
					'VERSION': '1.1.1',
					tiled: true,
...
///
		...
		var map = new ol.Map({
			...
			layers: [
				bingLayer, classification_boundry,parcel_boundry,district_layer,state_layer,plotselect
			],
			target: 'map',
			view: new ol.View({
				maxZoom: 19,
					...
					$.ajax({
						...
						data: {
							...
							success: function (response, textStatus, jqXHR) {
								...
								vector_layer.addFeatures(response);
						}
					});
				});
				//console.log(pp);				   
 ...
 $('#range_val').bind('keyup paste', function(){
		...
		//else { $('#code_value').html('<option value="">Select</option>');}	
            ...
            /*function getPlotTooltip() {
                ...
                map.on('singleclick', function (evt) {
                    ...
                    var url = "http://192.168.40.199/hoori/common/plot_popup/PL0000000002";
                    $.ajax({
                        method: "get",
                        url: url,
            ...
            /*function loadPagination(pagno) {
                ...
                $.ajax({
                    url: 'http://192.168.40.199/hoori/common/get_village_plot/' + pagno,
                    type: 'get',
            ...
            function createTable(result, sno) {
                ...
                for (index in result) {
                    ...
                    var url='http://192.168.40.199/hoori/'+url_plot;
                    var tr = "<tr>";
		...
		/*$(document).ready(function () {
		baseUrl = 'http://192.168.40.199/hoori/';
		setTimeout(function ()
		{
			$('.alert').hide('slow');
		}, 4000);
