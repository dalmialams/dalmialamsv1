...
<input type="hidden" name="shp_type" value="mining_lease_boundary">
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
			...
			<div class="panel-heading">
				...
				<h4 class="panel-title mg-right"><a class="btn btn-success" href="<?= url('document-management/document/manage-shape-data/mining_lease_boundary') ?>">Manage Lease Boundary</a></h4>
			</div>
