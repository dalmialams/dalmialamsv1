...
<?php if (!$viewMode) { ?>
    <div class="panel panel-primary  toggle panelMove panelClose panelRefresh">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(['url' => url('payment/submit-data'),'class' => 'form-horizontal payment-form','method' => 'POST', 'autocomplete'=>'off', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
            <div class="col-lg-12">
                <div class="row ">
                    <!-- Start .row -->
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-lg-7 col-md-9">
                            {{Form::select('payment[registration_id]', isset($reg_id_arr) ? $reg_id_arr : '', isset($payment_data['registration_id']) ? $payment_data['registration_id'] : '',array('class'=>'form-control select2-minimum required'))}}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                ...
                                <td  class="text-center">
                                    ...
                                    if(is_array($value['path']))
                                    {
                                        for($i = 0; $i < count($value['path']); $i++){
                                            $file_path = isset($value['path'][$i]) ? $value['path'][$i] : '';
