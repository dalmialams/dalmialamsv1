...
@if(!empty(Session::get('error-message')))
    <div class="alert alert-danger"><a href="javascript:void(0);" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>{!! Session::get('error-message')!!}</strong></div>
@endif
<?php if (!$viewMode) { ?>
            ...
            <?php if ($reg_uniq_no) { ?>
                ...
                <div class="col-lg-12">
                    <div class="row ">
                        <!-- Start .row -->
                        {{-- <?php dd($survey_data);?> --}}
                        <input type="hidden" name="survey[id]" value="{{ isset($survey_data['id']) ? base64_encode($survey_data['id']) : ""}}">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::text('survey[purchased_area]', isset($survey_data['purchased_area']) ? round($survey_data['purchased_area'],3) : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Purchased Area','id'=>'purchased_area','style'=>'text-align:right;')) }}
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::text('survey[patta_no]', isset($survey_data['patta_no']) ? round($survey_data['patta_no'],3) : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Patta Number','id'=>'purchased_area','style'=>'text-align:right;')) }}
                                <div id="purchase_area_msg" style="color: #db5565;font-size: 13px;font-weight: normal;"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::text('survey[khata_no]', isset($survey_data['khata_no']) ? round($survey_data['khata_no'],3) : '', array('class'=>'form-control required numbers_only_restrict check_calculation','placeholder' => 'Khata Number','id'=>'purchased_area','style'=>'text-align:right;')) }}
                                <div id="purchase_area_msg" style="color: #db5565;font-size: 13px;font-weight: normal;"></div>
                            </div>
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="classificationList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                ...
                                {{Form::select('survey[classification]', isset($plot_classification) ?$plot_classification : '' , isset($survey_data['classification']) ? $survey_data['classification'] : '',array('class'=>'form-control select2-minimum required'))}}
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group subclassificationList">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{ Form::textarea('survey[physical_verification]', isset($survey_data['physical_verification']) ? $survey_data['physical_verification'] : '', array('class'=>'form-control','placeholder' => 'Physical Verification','size' => '30x3')) }}
                            </div>
