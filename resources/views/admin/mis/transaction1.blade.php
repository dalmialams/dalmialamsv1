                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">                      
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group village-list">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('registration[village_id]', isset($village_info) ? $village_info : array('' => 'Select') , isset($village_id) ? $village_id : '',array('class'=>'form-control select2-minimum ','onchange' => '','id'=>'village_id'))}}
                            </div>
                        </div>  
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group" id="survey-list">
                            ...
                            <div class="col-lg-7 col-md-9">
                                {{Form::select('registration[survey_no]', isset($all_surveys) ?$all_surveys : '' ,  '',array('class'=>'form-control select2-minimum'))}}
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                ...
                                <a href="javascript:void(0)"><button type="button" class="btn btn-warning">Reset</button></a>
                            </div>
                        </div>
                        <!-- End .row -->
                    </div>
