...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        {!! Form::open(['url' => url('submit-forgot-password'),'class' => 'form-horizontal user-form','method' => 'POST', 'enctype' => 'multipart/form-data','role' => 'form']) !!}
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        {{ Form::text('password[user_name]',  '', array('class'=>'form-control required','placeholder' => 'Enter User Name')) }}
                    </div>
