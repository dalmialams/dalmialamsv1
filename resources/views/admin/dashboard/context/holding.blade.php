                    ...
                    <table id="tabletools1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php } ?>
                                <td class="all_total_area" style="text-align: right;"><?= $getGrandTotalAcer; ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= $total_area_details['grand_total_tot_area_acer'] ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= $total_area_details['grand_total_tot_area_hector'] ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= (($total_area_details['grand_total_tot_area_acer'] * 100)/ $getGrandTotalAcer ); ?></td>
                                <td class="all_total_area" style="text-align: right;"><?= $total_area_details['grand_total_tot_cost'] ?></td>
                            </tr>
