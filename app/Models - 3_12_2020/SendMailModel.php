   ...
   /*  public function sendWelcomeEmail($user_id, $new_password) {
	...
	public function sendWelcomeEmail($user_id, $new_password) {
		...
		//$message = 'Text Message';
		 ...
		 $str = '"D:\\sendmail\\senditquiet\\senditquiet" -s 192.168.40.140 -port 25 -u landmgmt@dalmiabharat.com -p Dalmia@2020 -f landmgmt@dalmiabharat.com -t '.$email.' -subject "'.$subject.'" -body "'.$message.'"';
		exec($str, $op, $ret);
