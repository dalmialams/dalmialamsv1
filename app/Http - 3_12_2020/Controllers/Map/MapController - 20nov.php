...
class MapController extends Controller {
    ...
    public function map(Request $request) {
			...
			//echo Config::get('geoserver.ADMIN_NAME');die;
//$this->data['geo_url'] = 'http://192.168.40.199:57169/geoserver/DALMIA-LAMS/wms';
$geo_url = $_SERVER['HTTP_HOST'];
$geo_port = '8080';

$this->data['geo_url'] = 'http://'.$geo_url.":".$geo_port.'/geoserver/DALMIA-LAMS/wms';
//echo $this->data['geo_url'];die;
