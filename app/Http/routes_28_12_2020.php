...
Route::get('dashboard/get_state_info', ['as' => 'get_state_info', 'uses' => 'Dashboard\AdminController@get_state_info'])->middleware(['auth','dashboard_access', 'auth_dashboard_state_dist_block_vil']);
...
Route::group(['prefix' => 'document-management/document', 'namespace' => 'DocumentManagement'], function() {
   // Route::any('list', ['as' => '', 'uses' => 'DocumentManageController@documentList']);
	 ...
	 Route::any('shape-file-remove/{id}', ['as' => '', 'uses' => 'DocumentManageController@shape_file_remove']);
	 Route::any('shape-file-view/{id}', ['as' => '', 'uses' => 'DocumentManageController@shape_file_view']);
	 Route::any('shape-map-view/{id}', ['as' => '', 'uses' => 'DocumentManageController@shape_map_view']);
	 ...
	 Route::get('importShp/{id1}/{id2}', ['as' => '', 'uses' => 'DocumentManageController@importShp']);
