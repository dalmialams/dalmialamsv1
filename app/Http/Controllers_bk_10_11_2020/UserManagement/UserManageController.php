...
class UserManageController extends Controller {
    ...
    public function userLog(Request $request) {
        ...
        if ($user_id && (!$start_date && !$end_date)) {
            ...
            $userSql = "Select $select from audit.logged_actions INNER JOIN \"T_USER\" ON audit.logged_actions.session_user_name=\"T_USER\".id where session_user_name = '{$user_id}' and (action_tstamp_tx between '{$start_date}' and '{$end_date}') order by event_id DESC";
        } else {
