...
ini_set('max_execution_time', '0');
	...
	$registration_comments =  DB::select("select cols.column_name,(select pg_catalog.col_description(oid,cols.ordinal_position::int) from pg_catalog.pg_class c where c.relname=cols.table_name) as column_comment from information_schema.columns cols where  cols.table_name!=''");
