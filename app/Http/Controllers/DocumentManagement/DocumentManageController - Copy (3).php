...
class DocumentManageController extends Controller {
	...
	public function getShpJson()
	{
	 ...
	 public function shape_file_view($id,$type='') { 
	...
	// export to shp
	function data_export_shp($table,$data_id) {				
		$shape_history_data = DB::select( DB::raw("select * from \"T_SHP_HISTORY\" where id = '".$data_id."'") );
