...
class DocumentManageController extends Controller {
	...
	public function shape_file_list(){
		...
		$this->data['shpHisTables'] = DB::select("select * from \"T_SHP_HISTORY\" where shp_type='survey_plot' and fl_archive = 'N' order by created_at desc");
	...
	public function mining_lease_boundary(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.MiningLeaseBoundary.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select( "select * from \"T_SHP_HISTORY\" where shp_type='mining_lease_boundary' and fl_archive = 'N' order by created_at desc");
		return view('admin.ShapeFileManagement.MiningLeaseBoundary.add', $this->data);
	}
	
	// Colony Boundary
	public function colony_boundary(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.ColonyBoundary.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select( "select * from \"T_SHP_HISTORY\" where shp_type='colony_boundary' and fl_archive = 'N' order by created_at desc");
		return view('admin.ShapeFileManagement.ColonyBoundary.add', $this->data);
	}
	
	 // Plant Boundary
	public function plant_boundary(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.PlantBoundary.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select("select * from \"T_SHP_HISTORY\" where shp_type='plant_boundary' and fl_archive = 'N' order by created_at desc");
	...
	public function truckyard(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.Truckyard.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select("select * from \"T_SHP_HISTORY\" where shp_type='truckyard' and fl_archive = 'N' order by created_at desc");
	...
	public function railway_sliding_boundary(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.RailwaySlidingBoundary.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select( "select * from \"T_SHP_HISTORY\" where shp_type='railway_sliding_boundary' and fl_archive = 'N' order by created_at desc");
	...
	public function approach_road(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.ApproachRoad.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select("select * from \"T_SHP_HISTORY\" where shp_type='approach_road' and fl_archive = 'N' order by created_at desc") ;
	...
	public function conveyor_belt(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.ConveyorBelt.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select("select * from \"T_SHP_HISTORY\" where shp_type='conveyor_belt' and fl_archive = 'N' order by created_at desc");
	...
	public function railway_track(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.RailwayTrack.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select("select * from \"T_SHP_HISTORY\" where shp_type='railway_track' and fl_archive = 'N' order by created_at desc");
	...
	public function crusher_location(){
		$this->data['pageHeading'] = 'Shape File <span class="text-danger" >Upload</span>';
		$this->data['include_script_view'] = 'admin.ShapeFileManagement.CrusherLocation.script';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
		$this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		$this->data['data']['jsArr'][] = 'assets/plugins/tables/datatables/jquery.dataTables.js';
		...
		$this->data['shpHisTables'] = DB::select("select * from \"T_SHP_HISTORY\" where shp_type='crusher_location' and fl_archive = 'N' order by created_at desc");
    ...
    // Drop Shape File	
	 public function shpDrop($table) {
        ...
        if($table){
			$sql = DB::select("DROP TABLE shptemp.".$table."");
            if(empty($sql)){
	...
	public function importShp($table,$shp_type,$data_id) {
        ...
        if($table){
			...
			if($shp_type == 'mining_lease_boundary'){
				$sql = DB::select( "INSERT INTO public.\"T_LEASE_BOUNDARY\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."") ;	
					if(!empty($sql)){
						DB::select( "DROP TABLE shptemp.".$table."") ;
			...
			if($shp_type == 'plant_boundary'){
				$sql = DB::select( "INSERT INTO public.\"T_PLANT_BOUNDARY\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."");	
					if(!empty($sql)){
						DB::select( "DROP TABLE shptemp.".$table."");
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
				...
				$sql = DB::select("INSERT INTO public.\"T_COLONY_BOUNDARY\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."");	
					if(!empty($sql)){
						DB::select("DROP TABLE shptemp.".$table."");
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
				...
				$sql = DB::select("INSERT INTO public.\"T_RAILWAY_SLIDING\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."");	
					if(!empty($sql)){
						DB::select("DROP TABLE shptemp.".$table."");
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
				...
				$sql = DB::select("INSERT INTO public.\"T_APPROACH_ROAD\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."");	
					if(!empty($sql)){
						DB::select("DROP TABLE shptemp.".$table."");
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
				...
				$sql = DB::select("INSERT INTO public.\"T_CONVEYOR_BELT\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."");	
					if(!empty($sql)){
						DB::select("DROP TABLE shptemp.".$table."");
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
				...
				$sql = DB::select("INSERT INTO public.\"T_RAILWAY_LINE\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."");	
					if(!empty($sql)){
						DB::select("DROP TABLE shptemp.".$table."");
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
				...
				$sql = DB::select( "INSERT INTO public.\"T_CRUSHER_LOCATION\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."");	
					if(!empty($sql)){
						DB::select( "DROP TABLE shptemp.".$table."");
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
				...
				$sql = DB::select("INSERT INTO public.\"T_TRUCKYARD\"(wkb_geometry) SELECT st_setsrid(st_Force2D(geom),4326) from shptemp.".$table."") ;	
					if(!empty($sql)){
						DB::select("DROP TABLE shptemp.".$table."") ;
						$data_to_update['imported'] = 'Y';
						$data_to_update['imported_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
			...
			$shpTables = DB::select("select * from shptemp." .$table ."");
			$val = array();
			if(!empty($shpTables)){
			foreach($shpTables as $key=>$val){
			//echo "select * from \"T_SURVEY_MAP\" where registration_id = '".$val->reg_id."' and survey_no = '".$val->surveyno."' and village = '".$val->village."'";die;	
			//$survey_map_data = DB::select( "select * from \"T_SURVEY_MAP\" where registration_id = '".$val->reg_id."' and survey_no = '".$val->surveyno."' and village = '".$val->village."'" );
						//DB::enableQueryLog(); 
						
			$chk_village_data = DB::select( "select * from \"T_VILLAGE\" where village_name = '".$val->village."'");	
            $chk_village_id = '';
			if(count($chk_village_data) > 0){

                $chk_village_id = $chk_village_data[0]->id;
							

			$survey_map_data = DB::select("select * from \"T_SURVEY_MAP\" where village_id = '".$chk_village_id."' and survey_no = '".$val->surveyno."'");

			if(count($survey_map_data) > 0){

                $msg = '<div class="alert alert-danger"><a href="javascript:void(0)" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Sorry, survey no with the village already exists!</strong></div>';				
				return redirect('document-management/document/shape-file-list')->with('message', $msg);
			}
			}else{
				 $msg = '<div class="alert alert-danger"><a href="javascript:void(0)" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Sorry, Village does not match with village master name!</strong></div>';				
				return redirect('document-management/document/shape-file-list')->with('message', $msg);
			...
			$sql = DB::select("INSERT INTO public.\"T_SURVEY_MAP\"(wkb_geometry,registration_id,state,district,taluk,village,survey_no) SELECT st_setsrid(st_Force2D(geom),4326),reg_id,state,district,taluk,village,surveyno from shptemp.".$table."");
            if(!empty($sql)){
	...
	public function getShpJson(Request $request)
	{
					  ...
					  if (file_exists($uploaded_path.'/'.$shpzip_file)) {				  
						...
						if (in_array($ext, $this->allowed_types)) {			 
							...
							if($shp_type =='mining_lease_boundary'){
								...
								$dir = $extractpath = "public/assets/files/shp_extract_data/truckyard/" . rtrim($shpzip, '.zip') . "/";
							...
							//echo $dir;
								...
								if ($isshpexist) {
								$exist_temp_table = DB::select("select * from information_schema.tables where table_schema = 'shptemp'");
								...
								foreach($exist_temp_table as $temp_table){
									...
									if($temp_table->table_name == 'temp_mining_lease_boundary' && $shp_type =='mining_lease_boundary'){
										...
										if($temp_table->table_name == 'temp_crusher_location'){
									      $sql = DB::select("DROP TABLE shptemp.temp_crusher_location");
										}
										break;
									}
									elseif($temp_table->table_name == 'temp_file' && $shp_type =='survey_plot'){
										if($temp_table->table_name == 'temp_file'){
									      $sql = DB::select("DROP TABLE shptemp.temp_file");	
										}
										break;
									}
								  }
								   ...
								   // if (!ini_get('safe_mode'))
									set_time_limit(0);
									putenv('PGPASSWORD=Qv4G9s@LxYp2uA3');
									putenv('PGUSER=postgres');
									putenv('PGHOST=localhost');
									putenv('PGPORT=5432');
									putenv('PGDATABASE=dalmia_lms');
									$table = preg_replace('/\s/', '', rtrim(strtolower($shpfile), '.shp'));
									$table = 'temp_file';
									
									if($shp_type =='mining_lease_boundary'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_mining_lease_boundary | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='plant_boundary'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_plant_boundary | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='colony_boundary'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_colony_boundary | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='truckyard'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_truckyard | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='railway_sliding_boundary'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_railway_sliding_boundary | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='approach_road'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_approach_road | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='conveyor_belt'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_conveyor_belt | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='railway_track'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_railway_track | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='crusher_location'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_crusher_location | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';
									}elseif($shp_type =='survey_plot'){
									$command = '"/usr/pgsql-16/bin/shp2pgsql" -d "' . base_path().'/' . $dir . $shpfile . '" shptemp.temp_file | "/usr/pgsql-16/bin/psql" -h localhost -d "dalmia_lms" -U postgres';	
//echo $command;die;									
}
			...
			$shpTables = DB::select("select * from information_schema.tables where table_schema = 'shptemp'");
			$val = array();
			$table_name = '';
			...
			if(!empty($shpTables)){
				foreach($shpTables as $key=>$val){
					if($val->table_name == 'temp_mining_lease_boundary' && $shp_type =='mining_lease_boundary'){	
						$extent = DB::select("select * from shptemp.temp_mining_lease_boundary");		
						...
						$extent = DB::select("select * from shptemp.temp_plant_boundary");		
						$val->plot_data = $extent;
						$table_name = 'temp_plant_boundary';	
						break;			
					}elseif($val->table_name == 'temp_colony_boundary' && $shp_type =='colony_boundary'){	
						$extent = DB::select("select * from shptemp.temp_colony_boundary");		
						$val->plot_data = $extent;
						$table_name = 'temp_colony_boundary';	
						break;			
					}elseif($val->table_name == 'temp_truckyard' && $shp_type =='truckyard'){	
						$extent = DB::select("select * from shptemp.temp_truckyard");		
						$val->plot_data = $extent;
						$table_name = 'temp_truckyard';	
						break;			
					}elseif($val->table_name == 'temp_railway_sliding_boundary' && $shp_type =='railway_sliding_boundary'){	
						$extent = DB::select("select * from shptemp.temp_railway_sliding_boundary");		
						$val->plot_data = $extent;
						$table_name = 'temp_railway_sliding_boundary';	
						break;			
					}elseif($val->table_name == 'temp_approach_road' && $shp_type =='approach_road'){	
						$extent = DB::select("select * from shptemp.temp_approach_road");		
						$val->plot_data = $extent;
						$table_name = 'temp_approach_road';	
						break;			
					}elseif($val->table_name == 'temp_conveyor_belt' && $shp_type =='conveyor_belt'){	
						$extent = DB::select("select * from shptemp.temp_conveyor_belt");		
						$val->plot_data = $extent;
						$table_name = 'temp_conveyor_belt';	
						break;			
					}elseif($val->table_name == 'temp_railway_track' && $shp_type =='railway_track'){	
						$extent = DB::select("select * from shptemp.temp_railway_track");		
						$val->plot_data = $extent;
						$table_name = 'temp_railway_track';	
						break;			
					}elseif($val->table_name == 'temp_crusher_location' && $shp_type =='crusher_location'){	
						$extent = DB::select("select * from shptemp.temp_crusher_location");		
						$val->plot_data = $extent;
						$table_name = 'temp_crusher_location';	
						break;			
					}elseif($val->table_name == 'temp_file' && $shp_type =='survey_plot'){
						$extent = DB::select( "select * from shptemp.temp_file" );		
						$val->plot_data = $extent;
     ...
     */
	 public function processData(Request $request) {
		...
		if (!empty($shape_file_doc)) {
           ...
           // $uploaded_path = 'public/assets/files/shp_data/';	
			...
			$uploaded_path = 'public/assets/files/shp_data/approach-road';	
			}elseif($shp_type == 'conveyor_belt'){
	 ...
	 public function shape_file_remove($shp_type,$id) {
        if (!empty($shp_type) && !empty($id)) {
            $data_to_update['fl_archive'] = 'Y';
			$data_to_update['deleted_by_user_id'] = ($this->data['current_user_id']) ? $this->data['current_user_id'] : '';
            $delete_id = ShapeHistoryModel::where(['id' => $id],['shp_type' => $shp_type])->update($data_to_update);
            if ($delete_id) {				
                ...
                $msg = '<div class="alert alert-success"><a href="javascript:void(0);" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Data deleted successfully!</strong></div>';
                    return redirect('document-management/document/'.$shp_link)->with('message', $msg);
            }
        } else {
                $msg = '<div class="alert alert-danger"><a href="javascript:void(0);" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Something went wrong!</strong></div>';
            return redirect('document-management/document/'.$shp_link)->with('message', $msg);
	...
	{ 
		$shpTables =  DB::select( ("select * from shptemp.temp_file where gid='$id'") );
	...
	public function update_shape_file(Request $request)
	{
		...
		$shp_history_data = DB::select( ("select * from \"T_SHP_HISTORY\" where id='$shpId'") );
		$shp_type = $shp_history_data[0]->shp_type;
		...
		return redirect('document-management/document/shape-file-view/'.$shpId.'/'.$shp_type.'/edited')->with('message', $msg);

	}
	
	// export to shp
	function data_export_shp($table,$type,$data_id) {				
		$shape_history_data = DB::select(("select * from \"T_SHP_HISTORY\" where id = '".$data_id."' and shp_type='".$type."'") );
		 ...
		 $file = File::files(public_path('assets/files/data_export_shp'));
			/*if($type == 'survey_plot'){
				...
				$path_name = 'mining_export_shp';
			    $file = File::files(public_path('assets/files/mining_export_shp'));
			}elseif($type == 'plant_boundary'){
				$path_name = 'plant_export_shp';
			    $file = File::files(public_path('assets/files/plant_export_shp'));
			}elseif($type == 'colony_boundary'){
				$path_name = 'colony_export_shp';
			    $file = File::files(public_path('assets/files/colony_export_shp'));
			}elseif($type == 'truckyard'){
				$path_name = 'truckyard_export_shp';
			    $file = File::files(public_path('assets/files/truckyard_export_shp'));
			}elseif($type == 'railway_sliding_boundary'){
				$path_name = 'railway_sliding_export_shp';
			    $file = File::files(public_path('assets/files/railway_sliding_export_shp'));
			}elseif($type == 'approach_road'){
				$path_name = 'approach_road_export_shp';
			    $file = File::files(public_path('assets/files/approach_road_export_shp'));
			}elseif($type == 'conveyor_belt'){
				$path_name = 'conveyor_belt_export_shp';
			    $file = File::files(public_path('assets/files/conveyor_belt_export_shp'));
			}elseif($type == 'railway_track'){
				$path_name = 'railway_track_export_shp';
			    $file = File::files(public_path('assets/files/railway_track_export_shp'));
			}elseif($type == 'crusher_location'){
				$path_name = 'crusher_location_export_shp';
			    $file = File::files(public_path('assets/files/crusher_location_export_shp'));
			}*/
			...
			if ($filename) {	
			   ...
			   $str = '"/usr/pgsql-16/bin/pgsql2shp" -f "D:\wamp\www\dalmia-lams\public\assets\files\data_export_shp/' . $filename . '" -h localhost -u postgres -P admin@123 DALMIA_LAMS shptemp.'.$table.' 2>&1'; 
	...
	function manage_village_export($village_id){
		$village_data_list = DB::select( "select * from \"T_SURVEY_MAP\" where village_id = '".$village_id."'");
		 ...
		 $this->allowed_types = ['zip'];
			...
			if ($filename) {	
			   ...
			   $dir = $zippath = public_path('assets/files/village_export_shp/'.$filename);		   
				...
				if(file_exists(public_path('assets/files/village_export_shp/'.$filename))){
	...
	public function manage_shape_data($shp_type) {
        $this->data['pageHeading'] = 'Shape Data <span class="text-danger" >Manage</span>';
        $this->data['include_script_view'] = 'admin.DocumentManagement.script';
        $this->data['data']['jsArr'][] = 'assets/plugins/forms/select2/select2.js';
        $this->data['data']['jsArr'][] = 'assets/js/formAjaxPlugin.js';
        $this->data['data']['jsArr'][] = 'assets/plugins/forms/validation/jquery.validate.js';
		...
		$this->data['shp_type'] = $shp_type;
		
       $shape_data = array();
	   if($shp_type == 'mining_lease_boundary'){
		    $shape_data = DB::table('T_LEASE_BOUNDARY')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'plant_boundary'){
		    $shape_data = DB::table('T_PLANT_BOUNDARY')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'colony_boundary'){
		    $shape_data = DB::table('T_COLONY_BOUNDARY')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'truckyard'){
		    $shape_data = DB::table('T_TRUCKYARD')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'railway_sliding_boundary'){
		    $shape_data = DB::table('T_RAILWAY_SLIDING')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'approach_road'){
		    $shape_data = DB::table('T_APPROACH_ROAD')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'conveyor_belt'){
		    $shape_data = DB::table('T_CONVEYOR_BELT')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'railway_track'){
		    $shape_data = DB::table('T_RAILWAY_LINE')->orderBy('ogc_fid','desc')->get();
	   }elseif($shp_type == 'crusher_location'){
		    $shape_data = DB::table('T_CRUSHER_LOCATION')->orderBy('ogc_fid','desc')->get();
	   }

		$this->data['shape_data'] = $shape_data;
        return view('admin.ManageShapeData.add', $this->data);
    }
	
	public function manage_shape_remove($type,$id)
	{
		$msg = '<div class="alert alert-success"><a href="javascript:void(0)" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Shape data deleted successfully!</strong></div>';				

		if($type == 'mining_lease_boundary'){
		DB::statement("DELETE from public.\"T_LEASE_BOUNDARY\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/mining_lease_boundary')->with('message', $msg);
		}elseif($type == 'plant_boundary'){
		DB::statement("DELETE from public.\"T_PLANT_BOUNDARY\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/plant_boundary')->with('message', $msg);
		}elseif($type == 'colony_boundary'){
		DB::statement("DELETE from public.\"T_COLONY_BOUNDARY\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/colony_boundary')->with('message', $msg);
		}elseif($type == 'truckyard'){
		DB::statement("DELETE from public.\"T_TRUCKYARD\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/truckyard')->with('message', $msg);
		}elseif($type == 'railway_sliding_boundary'){
		DB::statement("DELETE from public.\"T_RAILWAY_SLIDING\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/railway_sliding_boundary')->with('message', $msg);
		}elseif($type == 'approach_road'){
		DB::statement("DELETE from public.\"T_APPROACH_ROAD\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/approach_road')->with('message', $msg);
		}elseif($type == 'conveyor_belt'){
		DB::statement("DELETE from public.\"T_CONVEYOR_BELT\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/conveyor_belt')->with('message', $msg);
		}elseif($type == 'railway_track'){
		DB::statement("DELETE from public.\"T_RAILWAY_LINE\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/railway_track')->with('message', $msg);
		}elseif($type == 'crusher_location'){
		DB::statement("DELETE from public.\"T_CRUSHER_LOCATION\" where ogc_fid = '$id'");		
		return redirect('document-management/document/manage-shape-data/crusher_location')->with('message', $msg);
		}
	}
}
