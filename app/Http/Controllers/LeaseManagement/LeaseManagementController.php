...
class LeaseManagementController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        if (isset($this->assgined_districts_str) && !empty($this->assgined_districts_str)) {
            ...
            $reg_id_arr = RegistrationModel::whereRaw("district_id in ($this->assgined_districts_str)")->where(['purchase_type_id' => 'CD00144'])->orderBy('id')->pluck('id', 'id')->toArray();
        } else {
            $reg_id_arr = RegistrationModel::where(['purchase_type_id' => 'CD00144'])->orderBy('id')->pluck('id', 'id')->toArray();
        }
