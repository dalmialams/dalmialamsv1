...
$grand_total_tot_area = array();
                 ...
                 $states[$key]['purchased_area_in_acre'] = 0;
                 $states[$key]['purchased_area_in_hector'] = 0;
                 $states[$key]['total_cost'] = 0;
                 $states[$key]['leased_area_in_acre'] = 0;
                 $states[$key]['leased_area_in_hector'] = 0;
