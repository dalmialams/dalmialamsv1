...
class DisputesController extends Controller {
    ...
    public function processData(Request $request) {
		...
		//disp date
		$posted_disputes_data['disp_date'] = isset($posted_disputes_data['disp_date'])?date('Y-m-d',strtotime($posted_disputes_data['disp_date']):''; 
		//reminder date
		$posted_disputes_data['reminder_date'] = isset($posted_disputes_data['reminder_date'])?date('Y-m-d',strtotime($posted_disputes_data['reminder_date']):'';
		//next hear date
		$posted_disputes_data['next_hear_date'] = isset($posted_disputes_data['next_hear_date'])?date('Y-m-d',strtotime($posted_disputes_data['next_hear_date']):'';
