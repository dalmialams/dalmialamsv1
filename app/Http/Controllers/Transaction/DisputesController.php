...
class DisputesController extends Controller {
    ...
    public function processData(Request $request) {
		...
		//disp date
		$posted_disputes_data['disp_date'] = isset($posted_disputes_data['disp_date'])?date('Y-m-d',strtotime(str_replace('/', '-',$posted_disputes_data['disp_date']))):null; 
		//reminder date
		$posted_disputes_data['reminder_date'] = isset($posted_disputes_data['reminder_date'])?date('Y-m-d',strtotime(str_replace('/', '-',$posted_disputes_data['reminder_date']))):null;
		//next hear date
		$posted_disputes_data['next_hear_date'] = isset($posted_disputes_data['next_hear_date'])?date('Y-m-d',strtotime(str_replace('/', '-',$posted_disputes_data['next_hear_date']))):null;
		
		//t($posted_disputes_data);die;
